...
public abstract class Controller1
    ...
    private static final Log logger = LogFactory.getLog(Controller1.class);
    ...
    /**
     * This method is called when the use case 'OneUseCase UseCase1' starts.
     * It can be safely overridden in descendant classes.
     */
    protected void _oneUseCaseUseCase1_started()
    {
        //this method can be overridden
    }

    /**
     * @return oneUseCaseUseCase1
     */
    public String oneUseCaseUseCase1()
    {
        return oneUseCaseUseCase1((FacesEvent)null);
    }

    /**
     * @param event
     */
    public void oneUseCaseUseCase1(final ActionEvent event)
    {
        this.oneUseCaseUseCase1((FacesEvent)event);
    }

    /**
     * @param event
     */
    public void oneUseCaseUseCase1(final ValueChangeEvent event)
    {
        this.oneUseCaseUseCase1((FacesEvent)event);
    }
     ...
     * @return oneUseCaseUseCase1
     */
    public String oneUseCaseUseCase1(final FacesEvent event)
    {
        String forward = null;
    ...
    {
        String forward = null;
        forward = ((Controller1)this.resolveVariable("controller1")).oneUseCaseUseCase1();
