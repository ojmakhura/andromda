...
public abstract class Controller
     ...
     * @throws Throwable
     */
    public abstract void OperationNameAsUseCase()
        throws Throwable;
    ...
    /**
     * This method is called when the use case 'OperationNameAsUseCase' starts.
     * It can be safely overridden in descendant classes.
     */
    protected void _operationNameAsUseCase_started()
    {
        //this method can be overridden
    }

    /**
     * @return operationNameAsUseCase
     */
    public String operationNameAsUseCase()
    {
        return operationNameAsUseCase((FacesEvent)null);
    }

    /**
     * @param event
     */
    public void operationNameAsUseCase(final ActionEvent event)
    {
        this.operationNameAsUseCase((FacesEvent)event);
    }

    /**
     * @param event
     */
    public void operationNameAsUseCase(final ValueChangeEvent event)
    {
        this.operationNameAsUseCase((FacesEvent)event);
    }
     ...
     * @return operationNameAsUseCase
     */
    public String operationNameAsUseCase(final FacesEvent event)
    {
        String forward = null;
        ...
        try
        {
            ...
            _operationNameAsUseCase_started();

            forward = "operation-name-as-use-case-page";
            ...
            if (event != null)
            {
                OperationNameAsUseCaseViewPopulator.populateFormAndViewVariables(this.getContext(), null);
            }
        }
