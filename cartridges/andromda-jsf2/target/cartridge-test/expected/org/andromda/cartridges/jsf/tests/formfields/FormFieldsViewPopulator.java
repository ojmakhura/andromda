...
public final class FormFieldsViewPopulator
{
    ...
    static
    {
        populators.put("/org/andromda/cartridges/jsf/tests/formfields/one.xhtml", OnePopulator.class);
        populators.put("/org/andromda/cartridges/jsf/tests/formfields/one.jsf", OnePopulator.class);
        populators.put("/org/andromda/cartridges/jsf/tests/formfields/three.xhtml", ThreePopulator.class);
        populators.put("/org/andromda/cartridges/jsf/tests/formfields/three.jsf", ThreePopulator.class);
    }
}