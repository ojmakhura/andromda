    ...
    implements Filter
{
        ...
        throws ServletException
    {
        ...
        try
        {
            ...
            if (form != null)
            {
                ShowSomethingSendFormImpl duplicateActionsUsecaseShowSomethingSendForm =
                    (ShowSomethingSendFormImpl)variableResolver.resolveVariable(
                    facesContext,
                    "duplicateActionsUsecaseShowSomethingSendForm");
                // - populate the duplicateActionsUsecaseShowSomethingSendForm with any parameters from the previous form
                FormPopulator.populateForm(form, duplicateActionsUsecaseShowSomethingSendForm, false);
                request.setAttribute("duplicateActionsUsecaseShowSomethingSendForm", duplicateActionsUsecaseShowSomethingSendForm);
                ShowSomethingSubmitFormImpl duplicateActionsUsecaseShowSomethingSubmitForm =
                    (ShowSomethingSubmitFormImpl)variableResolver.resolveVariable(
                    facesContext,
                    "duplicateActionsUsecaseShowSomethingSubmitForm");
                // - populate the duplicateActionsUsecaseShowSomethingSubmitForm with any parameters from the previous form
                FormPopulator.populateForm(form, duplicateActionsUsecaseShowSomethingSubmitForm, false);
                request.setAttribute("duplicateActionsUsecaseShowSomethingSubmitForm", duplicateActionsUsecaseShowSomethingSubmitForm);
                ShowSomethingSubmitFormImpl duplicateActionsUsecaseShowSomethingSubmitForm =
                    (ShowSomethingSubmitFormImpl)variableResolver.resolveVariable(
                    facesContext,
                    "duplicateActionsUsecaseShowSomethingSubmitForm");
