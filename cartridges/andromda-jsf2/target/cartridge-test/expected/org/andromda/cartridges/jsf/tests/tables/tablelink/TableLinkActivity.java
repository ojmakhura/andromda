 ...
 * a URL call.
 */
public class TableLinkActivity
    extends HttpServlet
{
    /**  */
        ...
        throws ServletException, IOException
    {
        ...
        Controller controller =
            (Controller)FacesContextUtils.resolveVariable(
                request, response,
                "controller");
        final String forwardPath = UseCaseForwards.getPath(controller.tableLinkActivity());
        if(forwardPath != null){
            TableLinkActivityViewPopulator.populateFormAndViewVariables(
