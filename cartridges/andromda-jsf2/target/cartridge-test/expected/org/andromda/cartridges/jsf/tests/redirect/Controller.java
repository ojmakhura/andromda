...
public abstract class Controller
    ...
    /**
     * This method is called when the use case 'Redirect' starts.
     * It can be safely overridden in descendant classes.
     */
    protected void _redirect_started()
    {
    ...
    {
        return redirect((FacesEvent)null);
    }

    /**
     * @param event
     */
    public void redirect(final ActionEvent event)
    {
        this.redirect((FacesEvent)event);
    }

    /**
     * @param event
     */
    public void redirect(final ValueChangeEvent event)
    {
        this.redirect((FacesEvent)event);
    }
     ...
     * @return redirect
     */
    public String redirect(final FacesEvent event)
    {
        String forward = null;
     ...
     * @return forward
     */
    protected String _redirectAction( String forward)
    {
        //this method can be overridden
        return forward;
    }
    ...
    {
        String forward = null;
        forward = ((Controller)this.resolveVariable("controller")).redirect();
        forward = _redirectAction( forward);
        return forward;
    }
