...
public final class TableLinkActivityViewPopulator
{
    ...
    static
    {
        populators.put("/org/andromda/cartridges/jsf/tests/tables/tablelink/show-table-data.xhtml", ShowTableDataPopulator.class);
        populators.put("/org/andromda/cartridges/jsf/tests/tables/tablelink/show-table-data.jsf", ShowTableDataPopulator.class);
    }
}