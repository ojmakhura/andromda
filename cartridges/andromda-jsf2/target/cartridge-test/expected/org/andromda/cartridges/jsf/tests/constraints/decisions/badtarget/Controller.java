...
public abstract class Controller
     ...
     * @throws Throwable
     */
    public abstract Object thisOperationReturnsSomething()
        throws Throwable;
    ...
    /**
     * This method is called when the use case 'DecisionsBadTarget' starts.
     * It can be safely overridden in descendant classes.
     */
    protected void _decisionsBadTarget_started()
    {
        //this method can be overridden
    }

    /**
     * @return decisionsBadTarget
     */
    public String decisionsBadTarget()
    {
        return decisionsBadTarget((FacesEvent)null);
    }

    /**
     * @param event
     */
    public void decisionsBadTarget(final ActionEvent event)
    {
        this.decisionsBadTarget((FacesEvent)event);
    }

    /**
     * @param event
     */
    public void decisionsBadTarget(final ValueChangeEvent event)
    {
        this.decisionsBadTarget((FacesEvent)event);
    }
     ...
     * @return decisionsBadTarget
     */
    public String decisionsBadTarget(final FacesEvent event)
    {
        String forward = null;
        ...
        try
        {
            ...
            if (event != null)
            {
                DecisionsBadTargetViewPopulator.populateFormAndViewVariables(this.getContext(), null);
            }
        }
    ...
    {
        String forward = null;
        forward = "decisions-bad-target-show-something";
