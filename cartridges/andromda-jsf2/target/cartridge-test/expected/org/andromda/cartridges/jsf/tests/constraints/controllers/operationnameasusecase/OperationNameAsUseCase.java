 ...
 * a URL call.
 */
public class OperationNameAsUseCase
    extends HttpServlet
{
    /**  */
        ...
        throws ServletException, IOException
    {
        ...
        Controller controller =
            (Controller)FacesContextUtils.resolveVariable(
                request, response,
                "controller");
        final String forwardPath = UseCaseForwards.getPath(controller.operationNameAsUseCase());
        if(forwardPath != null){
            OperationNameAsUseCaseViewPopulator.populateFormAndViewVariables(
