...
/**
 * This filter handles the population of forms for the <em>page1</code>
 * view.
 */
public class Page1Populator
    implements Filter
{
        ...
        throws ServletException
    {
        ...
        try
        {
            ...
            if (form != null)
            {
                Page1SubmitFormImpl interActionStatePage1SubmitForm =
                    (Page1SubmitFormImpl)variableResolver.resolveVariable(
                    facesContext,
                    "interActionStatePage1SubmitForm");
                // - populate the interActionStatePage1SubmitForm with any parameters from the previous form
                FormPopulator.populateForm(form, interActionStatePage1SubmitForm, false);
                request.setAttribute("interActionStatePage1SubmitForm", interActionStatePage1SubmitForm);
            }
            // - serialize the form
            if (form != null)
            {
