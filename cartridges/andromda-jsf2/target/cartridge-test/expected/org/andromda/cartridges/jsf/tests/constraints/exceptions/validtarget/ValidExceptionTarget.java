 ...
 * a URL call.
 */
public class ValidExceptionTarget
    extends HttpServlet
{
    /**  */
        ...
        throws ServletException, IOException
    {
        ...
        Controller controller =
            (Controller)FacesContextUtils.resolveVariable(
                request, response,
                "controller");
        final String forwardPath = UseCaseForwards.getPath(controller.validExceptionTarget());
        if(forwardPath != null){
            ValidExceptionTargetViewPopulator.populateFormAndViewVariables(
