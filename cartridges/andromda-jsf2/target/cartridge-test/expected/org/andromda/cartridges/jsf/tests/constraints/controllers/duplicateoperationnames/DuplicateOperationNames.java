 ...
 * a URL call.
 */
public class DuplicateOperationNames
    extends HttpServlet
{
    /**  */
        ...
        throws ServletException, IOException
    {
        ...
        Controller controller =
            (Controller)FacesContextUtils.resolveVariable(
                request, response,
                "controller");
        final String forwardPath = UseCaseForwards.getPath(controller.duplicateOperationNames());
        if(forwardPath != null){
            DuplicateOperationNamesViewPopulator.populateFormAndViewVariables(
