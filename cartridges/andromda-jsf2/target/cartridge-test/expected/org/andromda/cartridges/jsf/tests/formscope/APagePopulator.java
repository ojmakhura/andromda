...
/**
 * This filter handles the population of forms for the <em>A Page</code>
 * view.
 */
public class APagePopulator
    implements Filter
{
        ...
        throws ServletException
    {
        ...
        try
        {
            ...
            if (form != null)
            {
                APageSubmitFormImpl formScopeAPageSubmitForm =
                    (APageSubmitFormImpl)variableResolver.resolveVariable(
                    facesContext,
                    "formScopeAPageSubmitForm");
                // - populate the formScopeAPageSubmitForm with any parameters from the previous form
                FormPopulator.populateForm(form, formScopeAPageSubmitForm, false);
                request.setAttribute("formScopeAPageSubmitForm", formScopeAPageSubmitForm);
            }
            // - serialize the form
            if (form != null)
            {
            ...
            if (form != null)
            {
                final boolean pageVarReadable = PropertyUtils.isReadable(form, "pageVar");
                if (pageVarReadable)
                {
                    Boolean propertySet = null;
                    final String isSetPropertyName = "pageVarSet";
                    ...
                    {
                        request.setAttribute("pageVar", PropertyUtils.getProperty(form, "pageVar"));
                    }
                }
            }
        }
