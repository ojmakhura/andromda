 ...
 * a URL call.
 */
public class TriggerPresentUseCase
    extends HttpServlet
{
    /**  */
        ...
        throws ServletException, IOException
    {
        ...
        $controller.fullyQualifiedName controller =
            ($controller.fullyQualifiedName)FacesContextUtils.resolveVariable(
                request, response,
                "$controller.beanName");
        final String forwardPath = UseCaseForwards.getPath(controller.triggerPresentUseCase());
        if(forwardPath != null){
            TriggerPresentUseCaseViewPopulator.populateFormAndViewVariables(
