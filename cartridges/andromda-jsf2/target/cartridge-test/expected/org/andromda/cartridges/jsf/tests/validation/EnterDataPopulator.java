...
/**
 * This filter handles the population of forms for the <em>enter data</code>
 * view.
 */
public class EnterDataPopulator
    implements Filter
{
        ...
        throws ServletException
    {
        ...
        try
        {
            ...
            if (form != null)
            {
                EnterDataValidateFormImpl validationActivityEnterDataValidateForm =
                    (EnterDataValidateFormImpl)variableResolver.resolveVariable(
                    facesContext,
                    "validationActivityEnterDataValidateForm");
                // - populate the validationActivityEnterDataValidateForm with any parameters from the previous form
                FormPopulator.populateForm(form, validationActivityEnterDataValidateForm, false);
                request.setAttribute("validationActivityEnterDataValidateForm", validationActivityEnterDataValidateForm);
            }
            // - serialize the form
            if (form != null)
            {
