    ...
    implements Filter
{
        ...
        throws ServletException
    {
        ...
        try
        {
            ...
            if (form != null)
            {
                State4Trigger4FormImpl deferringOperationsState4Trigger4Form =
                    (State4Trigger4FormImpl)variableResolver.resolveVariable(
                    facesContext,
                ...
                FormPopulator.populateForm(form, deferringOperationsState4Trigger4Form, false);
                request.setAttribute("deferringOperationsState4Trigger4Form", deferringOperationsState4Trigger4Form);
                State4FormImpl deferringOperationsState4Form =
                    (State4FormImpl)variableResolver.resolveVariable(
                    facesContext,
                    "deferringOperationsState4Form");
                // - populate the deferringOperationsState4Form with any parameters from the previous form
                FormPopulator.populateForm(form, deferringOperationsState4Form, false);
                request.setAttribute("deferringOperationsState4Form", deferringOperationsState4Form);
            }
            // - serialize the form
            if (form != null)
            {
            ...
            if (form != null)
            {
                final boolean testParam2BackingListReadable = PropertyUtils.isReadable(form, "testParam2BackingList");
                if (testParam2BackingListReadable)
                {
                    Object backingList = PropertyUtils.getProperty(form, "testParam2BackingList");
                    request.setAttribute("testParam2BackingList", backingList);
                }
            }
        }
