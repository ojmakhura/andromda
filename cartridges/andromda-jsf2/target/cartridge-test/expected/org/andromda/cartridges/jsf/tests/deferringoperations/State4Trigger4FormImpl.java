...
public class State4Trigger4FormImpl
    implements Serializable, DeferringOperationsForm, TestMissingArgumentFieldForm, Operation2Form
{
    /**
     * Default constructor
     */
    ...
    // Action deferring-operations-trigger4 formFields
    ...
    /**
     * Resets the value of the pageVariableSet to false
     */
    public void resetPageVariableSet()
    {
        this.pageVariableSet = false;
    }
    ...
    /**
     * 
     * @param pageVariableIn 
     */
    public void setPageVariable(String pageVariableIn)
    {
        this.pageVariable = pageVariableIn;
    ...
    /**
     * @param pageVariableValueListIn
     */
    public void setPageVariableValueList(Object[] pageVariableValueListIn)
    {
        this.pageVariableValueList = pageVariableValueListIn;
    }

    /**
     * @return pageVariableLabelList Object[]
     */
    ...
    /**
     * @param pageVariableLabelListIn
     */
    public void setPageVariableLabelList(Object[] pageVariableLabelListIn)
    {
        this.pageVariableLabelList = pageVariableLabelListIn;
    }
     ...
     * @param labelProperty
     */
    public void setPageVariableBackingList(Collection<? extends Object> items, String valueProperty, String labelProperty)
    {
        ...
        if (items != null)
        {
            ...
            try
            {
                ...
                for (final Iterator<? extends Object> iterator = items.iterator(); iterator.hasNext(); ctr++)
                {
                    ...
                    if (item != null)
                    {
                        this.pageVariableValueList[ctr] = valueProperty == null ? item :
                            PropertyUtils.getProperty(item, valueProperty.trim());
                        if (labelProperties == null)
                        {
                            this.pageVariableLabelList[ctr] = item;
                        }
                        else
                        {
                            ...
                            this.pageVariableLabelList[ctr] = labelText.toString().replaceAll("\\s+", " ").trim();
                        }
                    }
                }
            }
    ...
    private String param2a;

    /**
     * 
     * @return param2a 
     */
    public String getParam2a()
    {
        return this.param2a;
    }
    ...
    /**
     * Resets the value of the param2aSet to false
     */
    public void resetParam2aSet()
    {
        this.param2aSet = false;
    }
     ...
     * @param param2aIn 
     */
    public void setParam2a(String param2aIn)
    {
        this.param2a = param2aIn;
    ...
    /**
     * @param param2aValueListIn
     */
    public void setParam2aValueList(Object[] param2aValueListIn)
    {
        this.param2aValueList = param2aValueListIn;
    }

    /**
     * @return param2aLabelList Object[]
     */
    ...
    /**
     * @param param2aLabelListIn
     */
    public void setParam2aLabelList(Object[] param2aLabelListIn)
    {
        this.param2aLabelList = param2aLabelListIn;
    }
     ...
     * @param labelProperty
     */
    public void setParam2aBackingList(Collection<? extends Object> items, String valueProperty, String labelProperty)
    {
        ...
        if (items != null)
        {
            ...
            try
            {
                ...
                for (final Iterator<? extends Object> iterator = items.iterator(); iterator.hasNext(); ctr++)
                {
                    ...
                    if (item != null)
                    {
                        this.param2aValueList[ctr] = valueProperty == null ? item :
                            PropertyUtils.getProperty(item, valueProperty.trim());
                        if (labelProperties == null)
                        {
                            this.param2aLabelList[ctr] = item;
                        }
                        else
                        {
                            final StringBuilder labelText = new StringBuilder();
                            ...
                            while (ctr2 < labelDelimiters.size());
                            this.param2aLabelList[ctr] = labelText.toString().replaceAll("\\s+", " ").trim();
                        }
                    }
                }
            }
     ...
     */
     ...
     {
         this.resetPageVariableSet();
         this.resetTestParamSet();
         this.resetParam2aSet();
     ...
     */
    private static final long serialVersionUID = -5624522895238330275L;
}