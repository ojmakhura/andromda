 ...
 * 
 */
public class ResetPageSendWithResetFormImpl
    implements Serializable, SomeOperationForm
{
    /**
     * Default constructor
     */
    public ResetPageSendWithResetFormImpl()
    {
    ...
    // Action reset-send-with-reset formFields
    ...
    /**
     * Keeps track of whether or not the value of firstParam has
     * be populated at least once.
     */
    private boolean firstParamSet = false;

    /**
     * Resets the value of the firstParamSet to false
     */
    public void resetFirstParamSet()
    {
        this.firstParamSet = false;
    }

    /**
     * Indicates whether or not the value for firstParam has been set at least
     * once.
     *
     * @return true/false
     */
    public boolean isFirstParamSet()
    {
     ...
     * @param firstParamIn 
     */
    public void setFirstParam(String firstParamIn)
    {
        this.firstParam = firstParamIn;
    ...
    /**
     * @param firstParamValueListIn
     */
    public void setFirstParamValueList(Object[] firstParamValueListIn)
    {
        this.firstParamValueList = firstParamValueListIn;
    }

    /**
     * @return firstParamLabelList Object[]
     */
    ...
    /**
     * @param firstParamLabelListIn
     */
    public void setFirstParamLabelList(Object[] firstParamLabelListIn)
    {
        this.firstParamLabelList = firstParamLabelListIn;
    }
     ...
     * @param labelProperty
     */
    public void setFirstParamBackingList(Collection<? extends Object> items, String valueProperty, String labelProperty)
    {
        this.firstParamValueList = null;
        this.firstParamLabelList = null;
        if (items != null)
        {
            this.firstParamValueList = new Object[items.size()];
            this.firstParamLabelList = new Object[items.size()];
            ...
            try
            {
                ...
                for (final Iterator<? extends Object> iterator = items.iterator(); iterator.hasNext(); ctr++)
                {
                    ...
                    if (item != null)
                    {
                        this.firstParamValueList[ctr] = valueProperty == null ? item :
                            PropertyUtils.getProperty(item, valueProperty.trim());
                        if (labelProperties == null)
                        {
                            this.firstParamLabelList[ctr] = item;
                        }
                        else
                        {
                            ...
                            this.firstParamLabelList[ctr] = labelText.toString().replaceAll("\\s+", " ").trim();
                        }
                    }
                }
            }
     ...
     */
    private static final long serialVersionUID = 6059455616001173886L;
}