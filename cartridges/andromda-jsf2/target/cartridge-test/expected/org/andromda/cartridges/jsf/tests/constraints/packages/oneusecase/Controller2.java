...
public abstract class Controller2
    ...
    private static final Log logger = LogFactory.getLog(Controller2.class);
    ...
    /**
     * This method is called when the use case 'OneUseCase UseCase2' starts.
     * It can be safely overridden in descendant classes.
     */
    protected void _oneUseCaseUseCase2_started()
    {
        //this method can be overridden
    }

    /**
     * @return oneUseCaseUseCase2
     */
    public String oneUseCaseUseCase2()
    {
        return oneUseCaseUseCase2((FacesEvent)null);
    }

    /**
     * @param event
     */
    public void oneUseCaseUseCase2(final ActionEvent event)
    {
        this.oneUseCaseUseCase2((FacesEvent)event);
    }

    /**
     * @param event
     */
    public void oneUseCaseUseCase2(final ValueChangeEvent event)
    {
        this.oneUseCaseUseCase2((FacesEvent)event);
    }
     ...
     * @return oneUseCaseUseCase2
     */
    public String oneUseCaseUseCase2(final FacesEvent event)
    {
        String forward = null;
     ...
     * @return forward
     */
    protected String _nothing( String forward)
    {
        //this method can be overridden
        return forward;
    }
    ...
    {
        String forward = null;
        forward = ((Controller2)this.resolveVariable("controller2")).oneUseCaseUseCase2();
        forward = _nothing( forward);
        return forward;
    }
