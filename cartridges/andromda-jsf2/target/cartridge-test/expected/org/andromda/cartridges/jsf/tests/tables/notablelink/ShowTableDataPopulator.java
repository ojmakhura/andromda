    ...
    implements Filter
{
        ...
        throws ServletException
    {
        ...
        try
        {
            ...
            if (form != null)
            {
                ShowTableDataAgainFormImpl noTableLinkActivityShowTableDataAgainForm =
                    (ShowTableDataAgainFormImpl)variableResolver.resolveVariable(
                    facesContext,
                    "noTableLinkActivityShowTableDataAgainForm");
                // - populate the noTableLinkActivityShowTableDataAgainForm with any parameters from the previous form
                FormPopulator.populateForm(form, noTableLinkActivityShowTableDataAgainForm, false);
                request.setAttribute("noTableLinkActivityShowTableDataAgainForm", noTableLinkActivityShowTableDataAgainForm);
            }
            // - serialize the form
            if (form != null)
            {
            ...
            if (form != null)
            {
                ...
                final boolean customTablesReadable = PropertyUtils.isReadable(form, "customTables");
                if (customTablesReadable)
                {
                    Boolean propertySet = null;
                    final String isSetPropertyName = "customTablesSet";
                    if (PropertyUtils.isReadable(form, isSetPropertyName))
                    {
                        propertySet = (Boolean)PropertyUtils.getProperty(form, isSetPropertyName);
                    }
                    ...
                    if (propertySet == null || propertySet.booleanValue())
                    {
                        request.setAttribute("customTables", PropertyUtils.getProperty(form, "customTables"));
                    }
                }
            }
        }
