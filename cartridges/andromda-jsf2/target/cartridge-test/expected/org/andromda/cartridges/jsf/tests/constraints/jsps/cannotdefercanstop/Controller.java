...
public abstract class Controller
    ...
    /**
     * This method is called when the use case 'JspsCannotDeferCanStop' starts.
     * It can be safely overridden in descendant classes.
     */
    protected void _jspsCannotDeferCanStop_started()
    {
        //this method can be overridden
    }

    /**
     * @return jspsCannotDeferCanStop
     */
    public String jspsCannotDeferCanStop()
    {
        return jspsCannotDeferCanStop((FacesEvent)null);
    }

    /**
     * @param event
     */
    public void jspsCannotDeferCanStop(final ActionEvent event)
    {
        this.jspsCannotDeferCanStop((FacesEvent)event);
    }

    /**
     * @param event
     */
    public void jspsCannotDeferCanStop(final ValueChangeEvent event)
    {
        this.jspsCannotDeferCanStop((FacesEvent)event);
    }
     ...
     * @return jspsCannotDeferCanStop
     */
    public String jspsCannotDeferCanStop(final FacesEvent event)
    {
        String forward = null;
        ...
        try
        {
            ...
            _jspsCannotDeferCanStop_started();

            forward = "jsps-cannot-defer-can-stop-page";
            ...
            if (event != null)
            {
                JspsCannotDeferCanStopViewPopulator.populateFormAndViewVariables(this.getContext(), null);
            }
        }
