...
public abstract class Controller
    ...
    protected void resetFormSetFlags()
    {
        ...
        this.getPageVariablesForm().resetIsSetFlags();
    }
     ...
     * <em>pageVariablesShowSomethingSubmitForm</em> instance outside of its assigned controller operation).
    ...
    protected ShowSomethingSubmitFormImpl getShowSomethingSubmitForm()
    {
        ...
        final UIForm uiForm = this.findForm(this.getContext().getViewRoot(), "pageVariablesShowSomethingSubmitForm");
        this.populateComponentInputs(uiForm);
        return (ShowSomethingSubmitFormImpl)this.resolveVariable("pageVariablesShowSomethingSubmitForm");
    }
...
ShowSomethingSubmitFormImpl)
    ...
    public String showSomethingSubmit(final FacesEvent event)
    {
        ...
        try
        {
            ...
            if (event != null)
            {
                PageVariablesViewPopulator.populateFormAndViewVariables(this.getContext(), form);
            }
        }
    ...
    {
        String forward = null;
        forward = "page-variables-show-something";
        forward = _doSomething(form, forward);
        return forward;
    }

    /**
     * Retrieves the {@link PageVariablesFormImpl} form instance (normally you wont't
     * need to call this method explicitly, however this is here for times when you need to access the
     * <em>pageVariablesPageVariablesForm</em> instance outside of its assigned controller operation).
     * @return PageVariablesFormImpl
     */
    protected PageVariablesFormImpl getPageVariablesForm()
    {
        // - we do this in the case a button that submitted the form was set to immediate (this should be removed
        //   when we found a better way to handle this).
        final UIForm uiForm = this.findForm(this.getContext().getViewRoot(), "pageVariablesPageVariablesForm");
        this.populateComponentInputs(uiForm);
        return (PageVariablesFormImpl)this.resolveVariable("pageVariablesPageVariablesForm");
    }

    /**
     * This method is called when the use case 'PageVariables' starts.
     * It can be safely overridden in descendant classes.
PageVariablesFormImpl)
     * @param form
     */
    protected void _pageVariables_started(PageVariablesFormImpl form)
    {
        //this method can be overridden
    }
    ...
    {
        return pageVariables((FacesEvent)null);
    }

    /**
     * @param event
     */
    public void pageVariables(final ActionEvent event)
    {
        this.pageVariables((FacesEvent)event);
    }

    /**
     * @param event
     */
    public void pageVariables(final ValueChangeEvent event)
    {
        this.pageVariables((FacesEvent)event);
    }
     ...
     */
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public String pageVariables(final FacesEvent event)
    {
        String forward = null;
        final Object currentForm = this.resolveVariable("form");
        try
        {
            final PageVariablesFormImpl form =
                this.getPageVariablesForm();
            form.setEvent(event);
            this.setForm("form", form, true);
            // - pass any properties from the previous form along
            FormPopulator.populateForm(currentForm, form);
     ...
     * @return forward
     */
    protected String _doSomething(final PageVariablesFormImpl form, String forward)
    {
        //this method can be overridden
        return forward;
    }
     ...
     * @throws Throwable
     */
    private String _doSomething(final PageVariablesFormImpl form)
        throws Throwable
    {
        String forward = null;
        forward = "page-variables-show-something";
