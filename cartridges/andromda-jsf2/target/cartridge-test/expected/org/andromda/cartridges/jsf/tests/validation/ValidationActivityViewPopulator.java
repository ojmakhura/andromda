...
public final class ValidationActivityViewPopulator
{
    ...
    static
    {
        populators.put("/org/andromda/cartridges/jsf/tests/validation/enter-data.xhtml", EnterDataPopulator.class);
        populators.put("/org/andromda/cartridges/jsf/tests/validation/enter-data.jsf", EnterDataPopulator.class);
    }
}