    ...
    implements Serializable
{
    ...
    // Action form-scope-send-page-variable formFields
    ...
    /**
     * Resets the value of the pageVarSet to false
     */
    public void resetPageVarSet()
    {
        this.pageVarSet = false;
    }
     ...
     * @param pageVarIn 
     */
    public void setPageVar(String pageVarIn)
    {
        this.pageVar = pageVarIn;
    ...
    /**
     * @param pageVarValueListIn
     */
    public void setPageVarValueList(Object[] pageVarValueListIn)
    {
        this.pageVarValueList = pageVarValueListIn;
    }

    /**
     * @return pageVarLabelList Object[]
     */
    ...
    /**
     * @param pageVarLabelListIn
     */
    public void setPageVarLabelList(Object[] pageVarLabelListIn)
    {
        this.pageVarLabelList = pageVarLabelListIn;
    }
     ...
     * @param labelProperty
     */
    public void setPageVarBackingList(Collection<? extends Object> items, String valueProperty, String labelProperty)
    {
        ...
        if (items != null)
        {
            ...
            try
            {
                ...
                for (final Iterator<? extends Object> iterator = items.iterator(); iterator.hasNext(); ctr++)
                {
                    ...
                    if (item != null)
                    {
                        this.pageVarValueList[ctr] = valueProperty == null ? item :
                            PropertyUtils.getProperty(item, valueProperty.trim());
                        if (labelProperties == null)
                        {
                            this.pageVarLabelList[ctr] = item;
                        }
                        else
                        {
                            ...
                            this.pageVarLabelList[ctr] = labelText.toString().replaceAll("\\s+", " ").trim();
                        }
                    }
                }
            }
