...
public abstract class Controller
    ...
    /**
     * This method is called when the use case 'Named' starts.
     * It can be safely overridden in descendant classes.
     */
    protected void _named_started()
    {
    ...
    public String named()
    {
        return named((FacesEvent)null);
    }

    /**
     * @param event
     */
    public void named(final ActionEvent event)
    {
        this.named((FacesEvent)event);
    }

    /**
     * @param event
     */
    public void named(final ValueChangeEvent event)
    {
        this.named((FacesEvent)event);
    }
     ...
     * @return named
     */
    public String named(final FacesEvent event)
    {
        String forward = null;
    ...
    {
        String forward = null;
        forward = ((Controller)this.resolveVariable("controller")).named();
