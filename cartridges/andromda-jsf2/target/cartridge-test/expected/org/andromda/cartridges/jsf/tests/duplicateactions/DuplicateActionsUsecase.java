 ...
 * a URL call.
 */
public class DuplicateActionsUsecase
    extends HttpServlet
{
    /**  */
        ...
        throws ServletException, IOException
    {
        ...
        Controller controller =
            (Controller)FacesContextUtils.resolveVariable(
                request, response,
                "controller");
        final String forwardPath = UseCaseForwards.getPath(controller.duplicateActionsUsecase());
        if(forwardPath != null){
            DuplicateActionsUsecaseViewPopulator.populateFormAndViewVariables(
