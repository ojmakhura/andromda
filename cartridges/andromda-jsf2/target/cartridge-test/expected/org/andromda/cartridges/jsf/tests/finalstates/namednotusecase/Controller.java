...
public abstract class Controller
    ...
    /**
     * This method is called when the use case 'Namednotusecase' starts.
     * It can be safely overridden in descendant classes.
     */
    protected void _namednotusecase_started()
    {
        //this method can be overridden
    }

    /**
     * @return namednotusecase
     */
    public String namednotusecase()
    {
        return namednotusecase((javax.faces.event.FacesEvent)null);
    }

    /**
     * @param event
     */
    public void namednotusecase(final ActionEvent event)
    {
        this.namednotusecase((javax.faces.event.FacesEvent)event);
    }

    /**
     * @param event
     */
    public void namednotusecase(final javax.faces.event.ValueChangeEvent event)
    {
        this.namednotusecase((javax.faces.event.FacesEvent)event);
    }
     ...
     * @return namednotusecase
     */
    public String namednotusecase(final javax.faces.event.FacesEvent event)
    {
        String forward = null;
