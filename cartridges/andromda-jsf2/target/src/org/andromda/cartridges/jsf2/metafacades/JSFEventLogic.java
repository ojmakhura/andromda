 ...
 * MetafacadeLogic for JSFEvent
 *
 * @see JSFEvent
 */
public abstract class JSFEventLogic
    ...
    implements JSFEvent
{
     ...
     * @param context
     */
    protected JSFEventLogic(Object metaObjectIn, String context)
    {
     ...
     * @param context String. Set to JSFEvent if null
    ...
    private static String getContext(String context)
    {
        if (context == null)
        {
            context = "org.andromda.cartridges.jsf2.metafacades.JSFEvent";
        }
        return context;
    }
