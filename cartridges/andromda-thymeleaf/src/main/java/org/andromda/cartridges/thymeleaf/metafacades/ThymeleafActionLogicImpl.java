...
//     {
//         return MetafacadeWebUtils.toWebResourceName(this.getUseCase().getName() + "-" + super.getName());
//     }
...
//     {
//         return MetafacadeWebGlobals.ACTION_TYPE_TABLE.equals(this.findTaggedValue(MetafacadeWebProfile.TAGGEDVALUE_ACTION_TYPE));
//     }
...
//     /**
//      * @return findTaggedValue(MetafacadeWebProfile.TAGGEDVALUE_ACTION_RESETTABLE) isTrue
...
//     {
//         boolean popup = Objects.toString(this.findTaggedValue(MetafacadeWebProfile.TAGGEDVALUE_ACTION_TYPE)).equalsIgnoreCase(
...
// //        boolean dialog = Objects.toString(this.findTaggedValue(MetafacadeWebProfile.TAGGEDVALUE_ACTION_TYPE)).equalsIgnoreCase(
// //            MetafacadeWebGlobals.ACTION_TYPE_DIALOG);
// //        return dialog;
//     }
...
//     /**
//      * @return findTaggedValue(MetafacadeWebProfile.TAGGEDVALUE_ACTION_FORM_RESET)
//      * @see org.andromda.cartridges.thymeleaf.metafacades.ThymeleafAction#isFormResetRequired()
//      */
//     protected boolean handleIsFormReset()
//     {
//         return Boolean.valueOf(Objects.toString(this.findTaggedValue(
//             MetafacadeWebProfile.TAGGEDVALUE_ACTION_FORM_RESET), "")).booleanValue();
//     }
...
//     {
//         return this.getMessages(org.andromda.metafacades.uml.web.MetafacadeWebProfile.TAGGEDVALUE_ACTION_SUCCESS_MESSAGE);
//     }
    ...
    // {
    //     return this.getMessages(org.andromda.metafacades.uml.web.MetafacadeWebProfile.TAGGEDVALUE_ACTION_WARNING_MESSAGE);
    // }
