...
/**
 * Stores globals for the Thymeleaf cartridge metafacades.
 *
 * @author Chad Brandon
 */
public class ThymeleafGlobals
{
    /**
    ...
    /**
     * The pattern used for constructing the name of Thymeleaf converter classes (i.e.
