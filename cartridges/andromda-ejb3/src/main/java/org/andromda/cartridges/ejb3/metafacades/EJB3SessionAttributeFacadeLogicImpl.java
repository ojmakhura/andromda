...
public class EJB3SessionAttributeFacadeLogicImpl extends EJB3SessionAttributeFacadeLogic {
    ...
    protected boolean handleIsSeamAttribute() {
        ...
        if (this.isSeamBijectionIn() || this.isSeamBijectionLogger() || this.isSeamBijectionOut()
                || this.isSeamBijectionRequestParameter() || this.isSeamDataModel()
    ...
    protected String handleGetSeamBijectionInParameters() {
        ...
        if (!super.isRequired()) {
            ...
            if (BooleanUtils
                    .toBoolean((String) this.findTaggedValue(EJB3Profile.TAGGEDVALUE_SEAM_BIJECTION_IN_CREATE, true))) {
    ...
    protected String handleGetSeamDataModelSelectionIndexParameters() {
        List<String> parameters = new ArrayList<String>();
        String value = (String) this.findTaggedValue(EJB3Profile.TAGGEDVALUE_SEAM_DATA_DATAMODEL_SELECTION_INDEX_VALUE,
                true);
        if (StringUtils.isNotBlank(value)) {
            parameters.add("value = \"" + value + '\"');
        }
    ...
    protected String handleGetSeamBijectionRequestParameterParameters() {
        List<String> parameters = new ArrayList<String>();
        String value = (String) this.findTaggedValue(EJB3Profile.TAGGEDVALUE_SEAM_BIJECTION_REQUEST_PARAMETER_VALUE,
                true);
        if (StringUtils.isNotBlank(value)) {
            parameters.add("value = \"" + value + '\"');
        }
