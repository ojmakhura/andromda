...
public class CartridgeWebUtils {
    ...
    {
        return "email".equalsIgnoreCase(CartridgeWebUtils.getToken(
                format,
                0,
                2));
    }
    ...
    {
        return "equal".equalsIgnoreCase(CartridgeWebUtils.getToken(format, 0, 2));
    }
    ...
    {
        return "creditcard".equalsIgnoreCase(CartridgeWebUtils.getToken(format, 0, 2));
    }
    ...
    {
        return "pattern".equalsIgnoreCase(CartridgeWebUtils.getToken(format, 0, 2));
    }
    ...
    {
        return "minlength".equalsIgnoreCase(CartridgeWebUtils.getToken(
                format,
                0,
                2));
    }
    ...
    {
        return "maxlength".equalsIgnoreCase(CartridgeWebUtils.getToken(
                format,
                0,
                2));
    }
    ...
    {
        final Object value = element.findTaggedValue(CartridgeWebProfile.TAGGEDVALUE_INPUT_FORMAT);
    ...
    {
        return "range".equalsIgnoreCase(CartridgeWebUtils.getToken(
                format,
                0,
                2));
    }
    ...
    public static boolean isByte(final ClassifierFacade type)
    {
        return isType(
            type,
            CartridgeWebProfile.BYTE_TYPE_NAME);
    }
    ...
    public static boolean isShort(final ClassifierFacade type)
    {
        return isType(
            type,
            CartridgeWebProfile.SHORT_TYPE_NAME);
    }
    ...
    public static boolean isInteger(final ClassifierFacade type)
    {
        return isType(
            type,
            CartridgeWebProfile.INTEGER_TYPE_NAME);
    }
    ...
    public static boolean isLong(final ClassifierFacade type)
    {
        return isType(
            type,
            CartridgeWebProfile.LONG_TYPE_NAME);
    }
    ...
    public static boolean isFloat(final ClassifierFacade type)
    {
        return isType(
            type,
            CartridgeWebProfile.FLOAT_TYPE_NAME);
    }
    ...
    public static boolean isDouble(final ClassifierFacade type)
    {
        return isType(
            type,
            CartridgeWebProfile.DOUBLE_TYPE_NAME);
    }
    ...
    public static boolean isTime(final ClassifierFacade type)
    {
        return isType(
            type,
            CartridgeWebProfile.TIME_TYPE_NAME);
    }
    ...
    public static boolean isUrl(final ClassifierFacade type)
    {
        return isType(
            type,
            CartridgeWebProfile.URL_TYPE_NAME);
    }
    ...
    public static boolean isReadOnly(final ModelElementFacade element)
    {
        ...
        if (element != null)
        {
            final Object value = element.findTaggedValue(CartridgeWebProfile.TAGGEDVALUE_INPUT_READONLY);
    ...
    public static String getEqual(final ModelElementFacade element)
    {
        ...
        if (element != null)
        {
            final Object value = element.findTaggedValue(CartridgeWebProfile.TAGGEDVALUE_INPUT_EQUAL);
    ...
    public static String getValidWhen(final ModelElementFacade element)
    {
        ...
        if (element != null)
        {
            final Object value = element.findTaggedValue(CartridgeWebProfile.TAGGEDVALUE_INPUT_VALIDWHEN);
    ...
    {
        return CartridgeWebUtils.getToken(
            format,
            1,
            3);
    }
        ...
        final ClassifierFacade type)
    {
        ...
        if (element != null && type != null)
        {
            ...
            if (CartridgeWebUtils.isByte(type))
            {
                validatorTypesList.add("byte");
            }
            else if (CartridgeWebUtils.isShort(type))
            {
                validatorTypesList.add("short");
            }
            else if (CartridgeWebUtils.isInteger(type))
            {
                validatorTypesList.add("integer");
            }
            else if (CartridgeWebUtils.isLong(type))
            {
                validatorTypesList.add("long");
            }
            else if (CartridgeWebUtils.isFloat(type))
            {
                validatorTypesList.add("float");
            }
            else if (CartridgeWebUtils.isDouble(type))
            {
                validatorTypesList.add("double");
            }
            else if (CartridgeWebUtils.isDate(type))
            {
                validatorTypesList.add("date");
            }
            else if (CartridgeWebUtils.isTime(type))
            {
                validatorTypesList.add("time");
            }
            else if (CartridgeWebUtils.isUrl(type))
            {
            ...
            if (isRangeFormat)
            {
                if (CartridgeWebUtils.isInteger(type) || CartridgeWebUtils.isShort(type) || CartridgeWebUtils.isLong(type))
                {
                    validatorTypesList.add(VT_INT_RANGE);
                }
                if (CartridgeWebUtils.isFloat(type))
                {
                    validatorTypesList.add(VT_FLOAT_RANGE);
                }
                if (CartridgeWebUtils.isDouble(type))
                {
            ...
            if (format != null)
            {
                if (CartridgeWebUtils.isString(type) && CartridgeWebUtils.isEmailFormat(format))
                {
                    validatorTypesList.add(VT_EMAIL);
                }
                else if (CartridgeWebUtils.isString(type) && CartridgeWebUtils.isCreditCardFormat(format))
                {
                    validatorTypesList.add(VT_CREDIT_CARD);
                }
                else
                {
                    Collection formats = element.findTaggedValues(CartridgeWebProfile.TAGGEDVALUE_INPUT_FORMAT);
            ...
            if (CartridgeWebUtils.getValidWhen(element) != null)
            {
                validatorTypesList.add(VT_VALID_WHEN);
            }
            if (CartridgeWebUtils.getEqual(element) != null)
            {
            ...
            for (final Iterator iterator = taggedValues.iterator(); iterator.hasNext();)
            {
                ...
                validatorTypesList.add(CartridgeWebUtils.parseValidatorName(validator));
            }
        }
        ...
        final String validatorType)
    {
        ...
        {
            final String validatorFormat = CartridgeWebUtils.getInputFormat(element);
            if (CartridgeWebUtils.isStrictDateFormat(validatorFormat))
            {
        ...
        else if ("equal".equals(validatorType))
        {
            ...
            final String equal = CartridgeWebUtils.getEqual(element);
        ...
        for (final Iterator iterator = taggedValues.iterator(); iterator.hasNext();)
        {
            ...
            if (validatorType.equals(CartridgeWebUtils.parseValidatorName(validator)))
            {
                args.addAll(CartridgeWebUtils.parseValidatorArgs(validator));
            }
        }
        return args;
    }
    ...
    {
        CartridgeWebUtils.strictDateTimeFormat = strictDateTimeFormat;
    }
    ...
    {
        final String format = CartridgeWebUtils.getInputFormat(element);
        return CartridgeWebUtils.isStrictDateFormat(format);
    }
        ...
        final String defaultTimeFormat)
    {
        ...
        if (element != null && type != null)
        {
            format = CartridgeWebUtils.getInputFormat(element);
            if (format == null)
            {
            ...
            {
                format = CartridgeWebUtils.getDateFormat(format);
            }
        }
        return format;
    }
