 ...
 * @author Wouter Zoons
 */
public class CartridgeHibernateUtils
{
    /**
    ...
    public static boolean isVersion2(String hibernateVersionPropertyValue)
    {
        ...
        {
            version2 = hibernateVersionPropertyValue.startsWith(CartridgeHibernateGlobals.HIBERNATE_VERSION_2);
        }
        return version2;
    }
    ...
    public static boolean isVersion3(String hibernateVersionPropertyValue)
    {
        ...
        if (hibernateVersionPropertyValue != null)
        {
            version3 = hibernateVersionPropertyValue.startsWith(CartridgeHibernateGlobals.HIBERNATE_VERSION_3);
        }
        return version3;
    }
    ...
    public static boolean isVersion4(String hibernateVersionPropertyValue)
    {
        ...
        if (hibernateVersionPropertyValue != null)
        {
            version4 = hibernateVersionPropertyValue.startsWith(CartridgeHibernateGlobals.HIBERNATE_VERSION_4);
        }
        return version4;
    }
        ...
        String hibernateMappingStrategy)
    {
        ...
        return CartridgeHibernateGlobals.HIBERNATE_MAPPING_STRATEGY_SUBCLASS.equalsIgnoreCase(hibernateMappingStrategy);
    }
        ...
        String hibernateMappingStrategy)
    {
        ...
        if (CartridgeHibernateGlobals.HIBERNATE_MAPPING_STRATEGY_HIERARCHY.equalsIgnoreCase(hibernateMappingStrategy))
        {
            inheritanceType = "JOINED";
        }
        else if (CartridgeHibernateGlobals.HIBERNATE_MAPPING_STRATEGY_CONCRETE.equalsIgnoreCase(hibernateMappingStrategy))
        {
