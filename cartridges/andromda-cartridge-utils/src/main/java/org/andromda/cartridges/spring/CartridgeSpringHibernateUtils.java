 ...
 */
public class CartridgeSpringHibernateUtils
{
    /**
     * The version of Hibernate we're generating for.
     */
    private String hibernateVersion = CartridgeSpringGlobals.HIBERNATE_VERSION_5;
    ...
    /**
     * Indicates whether or not version 6 is the one that is currently being used.
     *
     * @return true/false
     */
    public boolean isVersion6()
    {
        return isVersion6(hibernateVersion);
    }
    ...
    {
        return hibernateVersionPropertyValue.startsWith(CartridgeSpringGlobals.HIBERNATE_VERSION_2);
    }
    ...
    {
        return hibernateVersionPropertyValue.startsWith(CartridgeSpringGlobals.HIBERNATE_VERSION_3);
    }
    ...
    {
        return hibernateVersionPropertyValue.startsWith(CartridgeSpringGlobals.HIBERNATE_VERSION_4);
    }
    ...
    {
        return hibernateVersionPropertyValue.startsWith(CartridgeSpringGlobals.HIBERNATE_VERSION_5);
    }

    /**
     * @param hibernateVersionPropertyValue
     * @return hibernateVersionPropertyValue.startsWith(SpringGlobals.HIBERNATE_VERSION_6)
     */
    public static boolean isVersion6(String hibernateVersionPropertyValue)
    {
        return hibernateVersionPropertyValue.startsWith(CartridgeSpringGlobals.HIBERNATE_VERSION_6);
    }
        ...
        String hibernateMappingStrategyIn)
    {
        ...
        return CartridgeSpringGlobals.HIBERNATE_MAPPING_STRATEGY_SUBCLASS.equalsIgnoreCase(hibernateMappingStrategyIn);
    }
}
