...
public abstract class AssociationLinkManagerFinder
{
     ...
     * </p>
     * 
     * @param self the association end that has to be checked
     ...
     * 
     * @param self this end of the association
     * @param otherEnd the other end of the association
     * @return is "self" the manager?
     */
    private static boolean isDefaultManager(
        AssociationEndFacade self,
