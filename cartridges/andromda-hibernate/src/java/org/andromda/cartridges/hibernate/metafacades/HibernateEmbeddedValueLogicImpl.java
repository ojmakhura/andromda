    ...
    extends HibernateEmbeddedValueLogic
{
    ...
    {
          final String implNamePattern = String.valueOf(this.getConfiguredProperty(
              HibernateGlobals.EMBEDDED_VALUE_IMPLEMENTATION_NAME_PATTERN));
    ...
    {
        return HibernateMetafacadeUtils.getFullyQualifiedName(this.getPackageName(), this.getName(), null);
    }
