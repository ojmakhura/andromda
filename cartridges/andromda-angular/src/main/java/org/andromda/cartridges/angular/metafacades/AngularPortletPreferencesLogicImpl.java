...
/**
 * Represents the portlet preferences for a given use case (assuming the Angular
 * application being generated is a portlet). MetafacadeLogic implementation for
 * org.andromda.cartridges.angular.metafacades.AngularPortletPreferences.
 *
