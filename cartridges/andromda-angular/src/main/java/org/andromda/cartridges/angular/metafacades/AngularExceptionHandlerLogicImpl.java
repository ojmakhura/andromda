 ...
 * org.andromda.cartridges.angular.metafacades.AngularExceptionHandler
    ...
    extends AngularExceptionHandlerLogic
{
    ...
    protected String handleGetExceptionPath()
    {
        ...
        if (target instanceof AngularForward)
        {
            return (target).getFullyQualifiedNamePath() + ".Angular";
        }
        else if (target instanceof AngularFinalState)
        {
            return ((AngularFinalState)target).getFullyQualifiedNamePath();
        }
        else
        {
            return "";
    ...
    {
        final Object value = this.findTaggedValue(AngularProfile.TAGGEDVALUE_EXCEPTION_TYPE);
