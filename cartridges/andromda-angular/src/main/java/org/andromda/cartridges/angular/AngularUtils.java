...
public class AngularUtils {
    ...
    public static String getDatatype(final String typeName) {
        ...
        if (typeName.contains("<")) {
            ...
            String generic = typeName.substring(0, x);
            ...
            String[] parameters = typeName.substring(x + 1, typeName.length() - 1).split("\\,");
            ...
            for (int j = 0; j < parameters.length; j++) {
                ...
                if(j == parameters.length - 1) {
                    builder.append(getDatatype(param));
                } else {
                    builder.append(getDatatype(param));
                    builder.append(", ");
                }
    ...
    public static boolean isArray(final String typeName) {
        ...
        if (typeName.contains("[]") || typeName.contains("Collection") || typeName.contains("List")
    ...
    public static Collection<?> getTableColumns(AngularAttribute attribute) {
        ...
        String identifierColumns = Objects
                .toString(attribute.findTaggedValue("andromda_presentation_view_field_table_identifier_columns"), "")
                .trim();
        String viewColumns = Objects.toString(attribute.findTaggedValue("andromda_presentation_view_table_columns"), "")
                .trim();
    ...
    public static boolean isTable(AngularAttribute attribute) {
        ...
        String viewColumns = Objects.toString(attribute.findTaggedValue("andromda_presentation_view_table_columns"), "")
                .trim();
        String fieldType = Objects.toString(attribute.findTaggedValue("andromda_presentation_web_view_field_type"), "")
                .trim();
