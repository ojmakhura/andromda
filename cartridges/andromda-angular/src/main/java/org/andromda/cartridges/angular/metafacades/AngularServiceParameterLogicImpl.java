 ...
 * MetafacadeLogic implementation for org.andromda.cartridges.angular.metafacades.AngularBackendServiceParameter.
 *
 * @see org.andromda.cartridges.angular.metafacades.AngularBackendServiceParameter
 */
public class AngularServiceParameterLogicImpl
    extends AngularServiceParameterLogic
{
    private static final long serialVersionUID = 34L;
    /**
     * Public constructor for AngularBackendServiceParameterLogicImpl
     * @see org.andromda.cartridges.angular.metafacades.AngularBackendServiceParameter
     */
    public AngularServiceParameterLogicImpl (Object metaObject, String context)
    {
     ...
     * The logger instance.
     */
    private static final Logger logger = Logger.getLogger(AngularServiceParameterLogicImpl.class);
    ...
    {
        boolean isAttribute = this.hasStereotype(AngularGlobals.STEREOTYPE_XML_ATTRIBUTE);
        if (!isAttribute)
        {
    ...
    {
        boolean isAttribute = this.hasStereotype(AngularGlobals.STEREOTYPE_XML_ELEMENT);
        if (!isAttribute)
        {
            String attributes = String.valueOf(this.getConfiguredProperty(USE_ATTRIBUTES));
            if (StringUtils.isEmpty(attributes))
    ...
    {
        String paramType = (String)this.findTaggedValue(AngularGlobals.REST_PARAM_TYPE);
    ...
    {
        String pathParam = (String)this.findTaggedValue(AngularGlobals.REST_PATH_PARAM);
    ...
    {
        String pathSegment = (String)this.findTaggedValue(AngularGlobals.REST_PATH_SEGMENT);
