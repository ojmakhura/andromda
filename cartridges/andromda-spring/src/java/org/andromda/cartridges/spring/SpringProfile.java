    ...
    extends UMLProfile
{
     ...
     */
    public static final String TAGGEDVALUE_EJB_TRANSACTION_TYPE = profile
        .get("EJB_TRANSACTION_TYPE");
     ...
     */
    public static final Object TAGGEDVALUEVALUE_MATCHMODE_ANYWHERE = profile
        .get("MATCHMODE_ANYWHERE");

    /**
     * The {@link net.sf.hibernate.expression.MatchMode#END} match mode.
     */
    public static final Object TAGGEDVALUEVALUE_MATCHMODE_END = profile
        .get("MATCHMODE_END");

    /**
     * The {@link net.sf.hibernate.expression.MatchMode#EXACT} match mode.
     */
    public static final Object TAGGEDVALUEVALUE_MATCHMODE_EXACT = profile
        .get("MATCHMODE_EXACT");

    /**
     * The {@link net.sf.hibernate.expression.MatchMode#START} match mode.
     */
    public static final Object TAGGEDVALUEVALUE_MATCHMODE_START = profile
        .get("MATCHMODE_START");
