...
/**
 * Stores globals for the Jakarta cartridge metafacades.
 *
 * @author Chad Brandon
 */
public class JakartaGlobals
{
    /**
    ...
    /**
     * The pattern used for constructing the name of Jakarta converter classes (i.e.
