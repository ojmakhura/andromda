 ...
 */
public class ValueObjectFacadeLogicImpl extends ValueObjectFacadeLogic implements ValueObjectFacade {
	// ---------------- constructor -------------------------------
	...
	/**
	 * Using <code>/</code> in the configuredProperty <code>valueObjectPackage</code> can 
	 * remove the previous package name.
	 * @see org.andromda.cartridges.ejb.metafacades.ValueObjectFacade#getPackageName()
	 */
	public String getPackageName() {
		String packageName = MessageFormat.format(this.getConfiguredProperty("valueObjectPackage").toString(),
	...
	public String getName() {
		return MessageFormat.format(this.getConfiguredProperty("valueObjectName").toString(),
				new String[] { StringUtils.trimToEmpty(super.getName())});
	}
	...
	/**
	 * If we're using inheritance to build up a value object with all model elements of an entity,
	 * we're returning no superclass.
	 */
