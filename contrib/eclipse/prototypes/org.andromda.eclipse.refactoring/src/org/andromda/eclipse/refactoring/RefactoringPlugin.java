package org.andromda.eclipse.refactoring;
...
public class RefactoringPlugin extends AbstractUIPlugin {
	...
	public ResourceBundle getResourceBundle() {
		try {
			if (resourceBundle == null)
				resourceBundle = ResourceBundle.getBundle("org.andromda.eclipse.refactoring.RefactoringPluginResources");
	...
	public static ImageDescriptor getImageDescriptor(String path) {
		return AbstractUIPlugin.imageDescriptorFromPlugin("org.andromda.eclipse.refactoring", path);
	}
}
