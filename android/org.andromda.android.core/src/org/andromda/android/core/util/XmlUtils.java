...
public class XmlUtils
{
    ...
    /**
     * Adds the <code>value</code> to the body of the <code>xmlObject</code>
     * 's first element.
     * 
     * @param object the XmlObject instance for which we'll add the value.
     * @param value the new value to add.
     */
    static void addTextValueToElement(XmlObject object, Object value)
    {
        final String methodName = "XmlUtils.addTextValueToFirstElement";
        if (object == null)
        {
            throw new IllegalArgumentException(methodName + " '" + object
                + "' " + "can not be null");
        }
    ...
    /**
     * Gets the text value (if any) from the body of the first element contained
     * within the XmlObject <code>object</code> instance.
     * 
     * @param object the XmlObject instance for which we'll add the value.
     ...
     */
    static XmlObject getNestedElement(XmlObject object, String name)
    {
    ...
    /**
     * Selects elements from the given <code>object</code> instance and using
     * the given <code>path</code>.
     * 
     * @param object the XmlObject instance from which the elements will be
     *        selected
     * @param path the path to use, should <strong>NOT </strong> start with any
     *        slashes.
     * @return the found XmlObject instances
     */
    static XmlObject[] selectElements(XmlObject object, String path)
    {
        ...
        String query = "declare namespace e='" + DEFAULT_QNAME_URI + "' "
            + ".//e:" + path;
        return object.selectPath(query);
    }

    /**
     * Gets the attribute value (if any) from the body of the first element
     * contained within the XmlObject <code>object</code> instance.
     * 
     * @param object the XmlObject instance for which we'll add the value.
     * @param name the name of the attribute.
     * @return the text value as a String
     */
    static String getAttributeValueFromElement(XmlObject object, String name)
    {
        String value = null;
        if (object != null)
        {
    ...
    /**
     * Adds an attribute with the given <code>name</code> having the given
     * <code>value</code> to <code>anyType</code> element, but does
     * <strong>NOT </strong> add the default namespace if no namespace is given
     * in the <code>name</code>.
     * 
     * @param anyType the XmlObject instance to which the attribute will be
     *        added.
     * @param value the new value to add.
     */
    static void addAttributeNoNamespace(
        XmlObject anyType,
        String name,
        Object value)
    {
    ...
    /**
     * Adds an attribute with the given <code>name</code> having the given
     * <code>value</code> to <code>anyType</code> element.
     * 
     * @param anyType the XmlObject instance to which the attribute will be
     *        added.
     * @param value the new value to add.
     */
    static void addAttribute(XmlObject anyType, String name, Object value)
    {
        final String methodName = "XmlUtils.addAttribute";
        if (anyType == null)
        {
            throw new IllegalArgumentException(methodName + " '" + anyType
                + "' " + "can not be null");
        }
    ...
    /**
     * Adds an element with the given <code>name</code> having the given
     * <code>value</code> to <code>anyType</code> element.
     * 
     * @param anyType the XmlObject instance to which the element will be added.
     * @param value the new value to add.
     */
    static void addElement(XmlObject anyType, String name, Object value)
    {
    ...
    /**
     * Adds an element with the given <code>name</code> to the
     * <code>anyType</code> element.
     * 
     * @param anyType the XmlObject instance to which the element will be added.
     * @param value the new value to add.
     */
    static void addElement(XmlObject anyType, String name)
    {
        final String methodName = "XmlUtils.addElement";
        if (anyType == null)
        {
    ...
    /**
     * Constructs a QName instance from the given <code>name</code> by
     * seperating the URI from the actual name.
     * 
    ...
    /**
     * Adds the given <code>text</code> to the element found having the
     * specified <code>elementName</code>.
     * 
     * @param anyType the any type element.
     * @param elementName the element name.
     * @param text the text to add
     */
    static void addCharactersToElement(XmlObject object, String text)
    {
     ...
     * <code>value</code> to the first element found with the given
     * <code>elementName</code> on the anyType element. In other words the
     * element having <code>elementName</code> must exist on
     * <code>anyType</code>.
     * 
     ...
     */
    static void addAttributeToElement(
        XmlObject anyType,
        String elementName,
        String name,
        Object value)
