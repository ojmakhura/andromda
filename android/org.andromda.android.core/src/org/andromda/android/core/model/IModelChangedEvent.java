...
/**
 * Model change events are fired by the model when it is changed from the last clean state. Model change listeners can
 * use these events to update accordingly.
 *
 * @author Eclipse.org
 * @author Peter Friese
 */
public interface IModelChangedEvent
{
     ...
     *
     * @return property that has been changed in the model object, or <samp>null </samp> if type is not CHANGE or if
     *         more than one property has been changed.
     */
    public String getChangedProperty();

    /**
     * When model change is of type <samp>CHANGE</samp>, this method is used to obtain the old value of the property
     * (before the change).
     *
    ...
    /**
     * When model change is of type <samp>CHANGE</samp>, this method is used to obtain the new value of the property
     * (after the change).
     *
    ...
    /**
     * Returns the type of change that occured in the model (one of <samp>INSERT</samp>, <samp>REMOVE</samp>,
     * <samp>CHANGE</samp> or <samp>WORLD_CHANGED </samp>).
     *
