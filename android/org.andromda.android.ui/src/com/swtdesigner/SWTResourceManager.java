 ...
 * operating system resources managed by cached objects when those objects and OS resources are no longer needed (e.g.
...
public class SWTResourceManager
{
    ...
    /**
     * Returns a font based on its name, height and style. Windows-specific strikeout and underline flags are also
     * supported.
     * 
     * @param name String The name of the font
     * @param height int The height of the font
