...
/*
        final String[][] fixture = new String[][]
        {
            new String[] { "", "" },
            new String[] { "               ", " " },
            new String[] { "AaaaaBbbbbCccccDdddd", "ABCDdddd" },
            new String[] { "ThisIsAnother long filename", "TIA l f" },
            new String[] { "this is a file", "t i a file" }
        };

        for (int i = 0; i < fixture.length; i++)
        {
            String[] strings = fixture[i];
            System.out.println(strings[0]+ "::"+strings[1]+" --> "+StringUtilsHelper.crunch(strings[0], 10));
