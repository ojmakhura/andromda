...
/**
 * The AndroMDA Translation Library implementation 
 * of the Plugin.
 * 
 * Library instances are configured from  
 * <code>META-INF/andromda-translation-library.xml</code> files 
...
public class Library extends BasePlugin {
    ...
    /**
     * Gets an instance of this Library configured
     * with <code>libraryXml</code>.
     * 
     * @param libraryXml the URL to the XML that
     *        configures this Library.
     * 
     * @return Library
     */
    public Library getInstance(URL libraryXml) {
        return (Library)getInstance(libraryXml, Library.class);    
    }
	...
	/**
	 * Gets the LibraryTranslation instances (keyed by name) 
	 ...
	 * 
	 * @param name
     * @return LibraryTranslation the LibraryTranslation corresponding
	...
	/**
	 * Sets the Translator class that will perform
