...
public class DirectionalAssociationDescriptor
{
	...
	public DirectionalAssociationDescriptor(
	...
	{
		return AssociationEndProxy.newInstance(scriptHelper,associationEnd);
	}


	public AssociationEnd getTarget()
	{
		return AssociationEndProxy.newInstance(scriptHelper,getOtherEnd());	
	}
