...
/**
 * Represents a single template &lt;&lt;modelElement/&gt;gt; within the
 * &lt;&lt;modelElements/&gt;gt; element.
 * 
...
public class TemplateModelElement
{
    ...
    /**
     * Adds the <code>modelElement</code> to the model elements belonging to
     * this TemplateModelElement.
     * 
     * @param modelElement the model element to add, can not be null;
     */
    ...
    /**
     * Sets the current model elements that belong to this TemplateModelElement
     * instanec.
     * 
    ...
    /**
     * Gets the current model elements that belong to this TemplateModelElement
     * instanec.
     * 
