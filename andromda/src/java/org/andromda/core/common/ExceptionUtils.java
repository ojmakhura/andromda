...
{
    /**
     * Checks if the argument is null, and if so, throws an
     * IllegalArgumentException, does nothing if not.
     * 
     * @param methodExecuteName the name of the method we are currently
     *        executing
        ...
        Object argument)
    {
        ...
        {
            throw new IllegalArgumentException("methodName: "
                + methodExecuteName + " - '" + argumentName
                + "' can not be null");
        }
    }

    /**
     * Checks if the argument is null or an empty String throws an
     * IllegalArgumentException if it is, does nothing if not.
     * 
     * @param methodExecuteName the name of the method we are currently
     *        executing
     * @param argumentName the name of the argument we are checking for null
     ...
     * 
     * @param methodExecuteName the method name of the method, this method is
     *        being executed within
     * @param assignableToClass the Class that argumentClass must be assignable
     *        to
        ...
        Class argumentClass)
    {
        ...
        {
            throw new IllegalArgumentException("methodName: "
                + methodExecuteName + " - '" + argumentName + "' class --> '"
                + argumentClass + "' must be assignable to class --> '"
                + assignableToClass + "'");
        }
    }
}