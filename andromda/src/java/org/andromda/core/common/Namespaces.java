...
/**
 * Dictionary of configurable Namespace objects. Namespace objects are used for
...
public class Namespaces
{
    ...
    /**
     * This is passed as the cartridge name for the findNamespaceProperty method
     * if we wish to use a 'default' Namespace for Plugins. This is so we don't
     * need to define a specific mapping for each Plugin if we don't want. If a
     * namespaceName exists with a specific Plugin name, then that will be used
    ...
    /**
     * Retrieves a property from the Namespace with the namespaceName. If the
     * <code>ignore</code> attribute of the Property instance is set to
     * <code>true</code> then lookup of the property will not be attempted and
     * null will just be returned instead. If the propety is not found and
     * <code>ignore<code> is not <code>true</code> a 
     ...
     * <code>ignore</code> attribute of the Property instance is set to
     * <code>true</code> then lookup of the property will not be attempted and
     * null will just be returned instead.
     * 
     * @param namespaceName name of the Plugin to which the namespace applies
     * @param propertyName name of the namespace property to find.
        ...
        boolean showWarning)
    {
        ...
        if (property == null)
        {
            if (logger.isDebugEnabled())
                logger.debug("no namespace with name '" + namespaceName
                    + "' found, looking for '" + DEFAULT + "'");
        ...
        else if (property == null && showWarning)
        {
            logger.warn("WARNING! Namespaces '" + DEFAULT + "' and '"
                + namespaceName + "' have no property '" + propertyName
