...
/**
 * Contains utilities for dealing with properties on object's with the AndroMDA
 * core.
 * 
 * @author Chad Brandon
 */
public class PropertyUtils
{
    /**
     * <p>
     * Indicates whether or not the given <code>object</code> contains a valid
     * property with the given <code>name</code> and <code>value</code>.
     * </p>
     * <p>
     ...
     * <li>If its a boolean value, then it evaluates to <code>true</code>
     * <li>
     * </ul>
        ...
        final String value)
    {
        ...
        try
        {
            if (org.apache.commons.beanutils.PropertyUtils.isReadable(
                ...
                name))
            {
                final Object propertyValue = org.apache.commons.beanutils.PropertyUtils
