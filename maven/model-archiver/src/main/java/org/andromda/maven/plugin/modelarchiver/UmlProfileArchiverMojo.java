    ...
    extends AbstractMojo
{
    ...
    /**
     * The directory for the generated uml profile.
     *
    ...
    /**
     * The name of the uml profile file to generate.
     *
        ...
        throws MojoExecutionException
    {
        ...
        try
        {
            ...
            {
                getLog().debug("Copy uml profile resources to " + buildDirectory.getAbsolutePath());
