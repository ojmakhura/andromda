    ...
    The project located in this directory has been generated by Vance Karimi
    using the andromdapp:generate Maven plugin.

    You should at least be running Maven 2.2.1 if you want to build your
    ...
    this might be a directory looking like this:
        ...
        (Windows)
        C:\Documents and Settings\Vance Karimi\.m2\repository\demo-ejb3\

        (*nix)
        /home/Vance Karimi/.maven/repository/demo-ejb3/
