 ...
 * </p>
 * <p>
 * In order to create a new component that can be registered/found through this
 * container you must perform the following steps:
 * <ol>
 ...
 * the component (i.e. org.andromda.core.repository.RepositoryFacade) and place
...
public class ComponentContainer
{
                ...
                if (component == null)
                {
                    ...
                    if (StringUtils.isNotEmpty(defaultImpl))
                    {
                        component = this.registerDefaultComponent(ClassUtils
                            .loadClass(typeName), ClassUtils
                            .loadClass(defaultImpl));
                    }
                    else
                    {
    ...
    public Collection findComponentsOfType(final Class type)
    {
        ...
        Collection components = new ArrayList(this.container
    ...
    public Object findComponentByNamespace(String namespace, String key)
    {
        ...
        ComponentContainer container = (ComponentContainer)this
            .findComponent(namespace);
        if (container != null)
        {
        ...
        String defaultTypeName)
    {
        ...
        try
        {
            return this.registerDefaultComponent(componentInterface, ClassUtils
                .loadClass(defaultTypeName));
        }
        catch (Throwable th)
        {
            String errMsg = "Error performing " + methodName;
