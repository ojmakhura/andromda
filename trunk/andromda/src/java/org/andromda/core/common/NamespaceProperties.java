...
/**
 * <p/>
 * Contains namespace properties used witin the AndroMDA core. </p>
 *
 * @author Chad Brandon
 */
public class NamespaceProperties
{
     ...
     * replacement of patterns in generated files during model processing time). </p>
     */
