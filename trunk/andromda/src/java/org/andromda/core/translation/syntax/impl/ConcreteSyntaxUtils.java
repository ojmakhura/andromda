...
public class ConcreteSyntaxUtils
{
    ...
    private static final Logger logger = Logger
        .getLogger(ConcreteSyntaxUtils.class);
    ...
    /**
     * Converts the passed <code>operation</code> to an instance of
     * <code>Operation</code> for the passed in operation.
     * 
     * @param operation
     * @return VariableDeclarations
     */
    public static OperationDeclaration getOperationDeclaration(
        POperation operation)
    {
        ...
        ATypeDeclaration typeDeclaration = (ATypeDeclaration)op
        ...
        AStandardDeclarator standardDeclarator)
    {
        ...
        ExceptionUtils.checkNull(
            ...
            "standardDeclarator",
            standardDeclarator);
        return ConcreteSyntaxUtils.getVariableDeclarations(standardDeclarator
        ...
        PVariableDeclarationList variableDeclarationList)
    {
        ...
        return (VariableDeclaration[])declarations
            .toArray(new VariableDeclaration[0]);
    }
        ...
        PFeatureCallParameters callParameters)
    {
        ...
        {
            PActualParameterList parameterList = ((AFeatureCallParameters)callParameters)
            ...
            if (parameterList != null)
            {
                ...
                if (restOfParams != null && !restOfParams.isEmpty())
                {
                    ...
                    {
                        ACommaExpression parameterListTail = (ACommaExpression)paramIt
                            .next();
                        parameters.add(TranslationUtils
                            .trimToEmpty(parameterListTail.getExpression()));
                    }
                }
            }
        }
    ...
    /**
     * Gets the left and right expressions of a PRelationalExpression and puts
     * then into a List. The left expression will be the first expression in the
     * list.
     * 
     * @param relationalExpression
     * @return the left and right parenthesis in [0] and [1] of the String[]
     */
    public static String[] getLeftAndRightExpressions(
        PRelationalExpression relationalExpression)
    {
