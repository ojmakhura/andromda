...
public class Expression
{
    ...
    /**
     * Appends a space charater to the current translated expression String
     * Buffer.
     */
     ...
     * toString result at the start and end positions of the buffer containing
     * the Expression.
     * 
    ...
    {
        return TranslationUtils.removeExtraWhitespace(this.translatedExpression
            .toString());
    }
    ...
    public String getContextElement()
    {
        ...
        {
            throw new ExpressionException(methodName
                + " - contextElement can not be null");
        }
     ...
     * 
     * @param contextElement the name of the element which is the context
     *        element.
     */
