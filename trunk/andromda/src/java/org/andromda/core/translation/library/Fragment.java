 ...
 * This fragment belongs to a Translation object.
 * 
...
public class Fragment {
	...
	/**
	 * The Translation to which this 
	 * Fragment belongs.
	 */
	private Translation translation;

	/**
	 * The possible kinds available to this
	 * Fragment
	 */
	private Map kinds = new HashMap();
	
	/**
	 * It doesn't make any sense to instatiate this
	 * object explicitly. It intended to be instantiated
	...
	/**
	 * Returns the kinds contained within
	 * this translation fragment
	 * 
	...
	/**
	 * Returns the body for the fragment kind with the
	 * specified name.
	 * 
	...
	/**
	 * Adds the specified kind having the specified 
	 * name and body to the Fragment.
	 * 
    ...
    /**
     * Sets the name of the handler method.  This method
     * is the method within the Translator that handles
     * the processing of the fragment.
     * 
