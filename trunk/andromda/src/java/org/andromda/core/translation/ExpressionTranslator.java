...
public class ExpressionTranslator
{
    ...
    /**
     * Performs translation of the <code>expression</code> by looking up the <code>translationName</code> from the
     * available Translation-Libraries found on the classpath.
     *
     * @param translationName the name of the translation to use for translating (i.e. a translationName like
     *                        'query.EJB-QL' would mean use the <code>EJB-QL</code> translation from the
     *                        <code>query</code> library.
     * @param expression      the actual expression to translate.
     * @param contextElement  the element which provides the context of this expression. This is passed from the model.
     *                        This can be null.
