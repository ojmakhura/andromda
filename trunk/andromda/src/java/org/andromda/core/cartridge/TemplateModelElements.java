...
public class TemplateModelElements
{
    ...
    /**
     * Adds a modelElement to the Map of <code>modelElements</code> and keys
     * it by <code>stereotype</code>. The <code>stereotype</code> of the
     * modelElement must be defined.
     * 
    ...
    public void addModelElement(TemplateModelElement modelElement)
    {
        ...
        String stereotype = StringUtils.trimToEmpty(modelElement
            .getStereotype());
    ...
    /**
     * Retrieves the TemplateModelElement having the given
     * <code>stereotypeName</code>.
     * 
    ...
    /**
     * Retrieves the model elements bound to the stereotype having the given
     * <code>stereotypeName</code>.
     * 
    ...
    /**
     * Gets all model elements for each TemplateModelElement belonging to this
     * TemplateModelElements instance.
     * 
     ...
     * 
     * @param stereotypeName the name of the stereotype of which to retrieve the
     *        variable
     */
    ...
    /**
     * Returns an Iterator containing all stereotype names for the modelElement
     * stereotypes of this instance.
     * 
     * @return Iterator
     */
