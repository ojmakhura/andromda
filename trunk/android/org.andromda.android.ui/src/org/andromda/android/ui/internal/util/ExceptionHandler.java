 ...
 * <code>InvocationTargetException</code> a normal message dialog pops up showing the exception's message.
...
public class ExceptionHandler
{
     ...
     * error code <code>JavaStatusConstants.INTERNAL_ERROR</code>.
     */
    ...
    public static void handle(CoreException e,
        ...
        String message)
    {
        handle(e, AndroidUIPlugin.getActiveWorkbenchShell(), title, message);
    }
    ...
    /**
     * Handles the given <code>InvocationTargetException</code>. The workbench shell is used as a parent for the
     * dialog window.
     * 
    ...
    protected void perform(CoreException e,
        Shell shell,
        String title,
        String message)
    {
    ...
    protected void perform(InvocationTargetException e,
        Shell shell,
        String title,
        String message)
    {
    ...
    private void displayMessageDialog(Throwable t,
