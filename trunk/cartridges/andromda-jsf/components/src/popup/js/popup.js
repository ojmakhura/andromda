var andromdaJsfPopupStack = new Array();
var andromdaJsfPopupPosition = -1;
...
{
    andromdaJsfPopupPosition++;
    andromdaJsfPopupStack[andromdaJsfPopupPosition] = exec;
}
function executeListeners(anEvent)
{
    for(ctr = 0; ctr < andromdaJsfPopupStack.length; ctr++)
    {
        eval(andromdaJsfPopupStack[ctr] + "(anEvent);");
    }
}
