 ...
 * a URL call.
 */
public class NoTableLinkActivity
    extends HttpServlet
{
    /**  */
        ...
        throws ServletException, IOException
    {
        ...
        Controller controller =
            (Controller)FacesContextUtils.resolveVariable(
                request, response,
                "controller");
        final String forwardPath = UseCaseForwards.getPath(controller.noTableLinkActivity());
        if(forwardPath != null){
            NoTableLinkActivityViewPopulator.populateFormAndViewVariables(
