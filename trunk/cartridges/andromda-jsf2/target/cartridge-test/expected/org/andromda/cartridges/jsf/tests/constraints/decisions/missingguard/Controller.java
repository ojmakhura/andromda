...
public abstract class Controller
    ...
    /**
     * This method is called when the use case 'DecisionsMissingGuard' starts.
     * It can be safely overridden in descendant classes.
     */
    protected void _decisionsMissingGuard_started()
    {
        //this method can be overridden
    }

    /**
     * @return decisionsMissingGuard
     */
    public String decisionsMissingGuard()
    {
        return decisionsMissingGuard((FacesEvent)null);
    }

    /**
     * @param event
     */
    public void decisionsMissingGuard(final ActionEvent event)
    {
        this.decisionsMissingGuard((FacesEvent)event);
    }

    /**
     * @param event
     */
    public void decisionsMissingGuard(final ValueChangeEvent event)
    {
        this.decisionsMissingGuard((FacesEvent)event);
    }
     ...
     * @return decisionsMissingGuard
     */
    public String decisionsMissingGuard(final FacesEvent event)
    {
        String forward = null;
        ...
        try
        {
            ...
            _decisionsMissingGuard_started();
    ...
    private String __operation()
        throws Throwable
    {
        final String value = String.valueOf(operation());
