...
import my.packagename.ServiceLocator;
...
public abstract class Controller
     ...
     * @throws Throwable
     */
    public abstract void crapmeout()
        throws Throwable;
     ...
     * @throws Throwable
     */
    public abstract void anOperation(AnOperationForm form)
        throws Throwable;
     ...
     * @throws Throwable
     */
    public abstract void anOperation1(AnOperation1Form form)
        throws Throwable;
     ...
     * @throws Throwable
     */
    public abstract void anOperation2(AnOperation2Form form)
        throws Throwable;
    ...
    /**
     * This method is called when the use case 'Services' starts.
     * It can be safely overridden in descendant classes.
     */
    protected void _services_started()
    {
    ...
    {
        return services((FacesEvent)null);
    }

    /**
     * @param event
     */
    public void services(final ActionEvent event)
    {
        this.services((FacesEvent)event);
    }

    /**
     * @param event
     */
    public void services(final ValueChangeEvent event)
    {
        this.services((FacesEvent)event);
    }
     ...
     * @return services
     */
    public String services(final FacesEvent event)
    {
        String forward = null;
        ...
        try
        {
            ...
            if (event != null)
            {
                ServicesViewPopulator.populateFormAndViewVariables(this.getContext(), null);
            }
        }
    ...
    /**
     * Returns a reference to the controllerService back-end service.
     * @return ServiceLocator.instance().getService()
     */
    protected final Service getControllerService()
    {
        try
        {
            return ServiceLocator.instance().getService();
