...
public abstract class Controller
     ...
     * @throws Throwable
     */
    public abstract void duplicateName(DuplicateNameForm form)
        throws Throwable;
    ...
    /**
     * This method is called when the use case 'duplicate operation names' starts.
     * It can be safely overridden in descendant classes.
     */
    protected void _duplicateOperationNames_started()
    {
        //this method can be overridden
    }

    /**
     * @return duplicateOperationNames
     */
    public String duplicateOperationNames()
    {
        return duplicateOperationNames((FacesEvent)null);
    }

    /**
     * @param event
     */
    public void duplicateOperationNames(final ActionEvent event)
    {
        this.duplicateOperationNames((FacesEvent)event);
    }

    /**
     * @param event
     */
    public void duplicateOperationNames(final ValueChangeEvent event)
    {
        this.duplicateOperationNames((FacesEvent)event);
    }
     ...
     * @return duplicateOperationNames
     */
    public String duplicateOperationNames(final FacesEvent event)
    {
        String forward = null;
        ...
        try
        {
            ...
            _duplicateOperationNames_started();

            forward = "duplicate-operation-names-show-something";
            ...
            if (event != null)
            {
                DuplicateOperationNamesViewPopulator.populateFormAndViewVariables(this.getContext(), null);
            }
        }
