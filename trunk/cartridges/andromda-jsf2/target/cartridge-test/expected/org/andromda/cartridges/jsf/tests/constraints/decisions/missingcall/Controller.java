...
public abstract class Controller
    ...
    /**
     * This method is called when the use case 'DecisionsMissingCall' starts.
     * It can be safely overridden in descendant classes.
     */
    protected void _decisionsMissingCall_started()
    {
        //this method can be overridden
    }

    /**
     * @return decisionsMissingCall
     */
    public String decisionsMissingCall()
    {
        return decisionsMissingCall((javax.faces.event.FacesEvent)null);
    }

    /**
     * @param event
     */
    public void decisionsMissingCall(final ActionEvent event)
    {
        this.decisionsMissingCall((javax.faces.event.FacesEvent)event);
    }

    /**
     * @param event
     */
    public void decisionsMissingCall(final javax.faces.event.ValueChangeEvent event)
    {
        this.decisionsMissingCall((javax.faces.event.FacesEvent)event);
    }
     ...
     * @return decisionsMissingCall
     */
    public String decisionsMissingCall(final javax.faces.event.FacesEvent event)
    {
        String forward = null;
    ...
    {
        String forward = null;
        forward = __${transition.operationCall.name}();
     ...
     * 
     */
    private String __${decisionTransition.operationCall.name}()
        throws Throwable
    {
