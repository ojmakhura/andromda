...
public abstract class Controller
    ...
    {
        // Resets all the "isSet" flags on the forms to false.
        this.getShowSomethingParamhrefForm().resetIsSetFlags();
        this.getShowSomethingNoparamhrefForm().resetIsSetFlags();
        this.getHyperlinkactionsForm().resetIsSetFlags();
    }

    /**
     * Retrieves the {@link ShowSomethingParamhrefFormImpl} form instance (normally you wont't
     * need to call this method explicitly, however this is here for times when you need to access the
     * <em>hyperlinkactionsShowSomethingParamhrefForm</em> instance outside of its assigned controller operation).
     * @return ShowSomethingParamhrefFormImpl
     */
    protected ShowSomethingParamhrefFormImpl getShowSomethingParamhrefForm()
    {
        ...
        final UIForm uiForm = this.findForm(this.getContext().getViewRoot(), "hyperlinkactionsShowSomethingParamhrefForm");
        this.populateComponentInputs(uiForm);
        return (ShowSomethingParamhrefFormImpl)this.resolveVariable("hyperlinkactionsShowSomethingParamhrefForm");
    }

    /**
     * 
     * This method is called when 'paramhref' is triggered in the view 'show something'.
     * It can be safely overridden in descendant classes.
ShowSomethingParamhrefFormImpl)
     * @param form
     */
    protected void _showSomething_paramhref(ShowSomethingParamhrefFormImpl form)
    {
        //this method can be overridden
    }

    /**
     * @return showSomethingParamhref
     */
    public String showSomethingParamhref()
    {
        return showSomethingParamhref((FacesEvent)null);
    }

    /**
     * @param event
     */
    public void showSomethingParamhref(final ActionEvent event)
    {
        this.showSomethingParamhref((FacesEvent)event);
    }

    /**
     * @param event
     */
    public void showSomethingParamhref(final ValueChangeEvent event)
    {
        this.showSomethingParamhref((FacesEvent)event);
    }
    ...
    public String showSomethingParamhref(final FacesEvent event)
    {
        String forward = null;
        final Object currentForm = this.resolveVariable("form");
        try
        {
            final ShowSomethingParamhrefFormImpl form =
                this.getShowSomethingParamhrefForm();
            form.setEvent(event);
            ...
            if (event != null)
            {
                HyperlinkactionsViewPopulator.populateFormAndViewVariables(this.getContext(), form);
            }
        }
     ...
     * @return forward
     */
    protected String _doSomething(final ShowSomethingParamhrefFormImpl form, String forward)
    {
        //this method can be overridden
        return forward;
    }
     ...
     * @throws Throwable
     */
    private String _doSomething(final ShowSomethingParamhrefFormImpl form)
        throws Throwable
    {
        String forward = null;
        forward = "hyperlinkactions-show-something";
        forward = _doSomething(form, forward);
        return forward;
    }

    /**
     * Retrieves the {@link ShowSomethingNoparamhrefFormImpl} form instance (normally you wont't
     * need to call this method explicitly, however this is here for times when you need to access the
     * <em>hyperlinkactionsShowSomethingNoparamhrefForm</em> instance outside of its assigned controller operation).
     * @return ShowSomethingNoparamhrefFormImpl
     */
    protected ShowSomethingNoparamhrefFormImpl getShowSomethingNoparamhrefForm()
    {
        // - we do this in the case a button that submitted the form was set to immediate (this should be removed
        //   when we found a better way to handle this).
        final UIForm uiForm = this.findForm(this.getContext().getViewRoot(), "hyperlinkactionsShowSomethingNoparamhrefForm");
        this.populateComponentInputs(uiForm);
        return (ShowSomethingNoparamhrefFormImpl)this.resolveVariable("hyperlinkactionsShowSomethingNoparamhrefForm");
    }

    /**
     * 
     * This method is called when 'noparamhref' is triggered in the view 'show something'.
     * It can be safely overridden in descendant classes.
ShowSomethingNoparamhrefFormImpl)
     * @param form
     */
    protected void _showSomething_noparamhref(ShowSomethingNoparamhrefFormImpl form)
    {
        //this method can be overridden
    }

    /**
     * @return showSomethingNoparamhref
     */
    public String showSomethingNoparamhref()
    {
        return showSomethingNoparamhref((FacesEvent)null);
    }

    /**
     * @param event
     */
    public void showSomethingNoparamhref(final ActionEvent event)
    {
        this.showSomethingNoparamhref((FacesEvent)event);
    }

    /**
     * @param event
     */
    public void showSomethingNoparamhref(final ValueChangeEvent event)
    {
        this.showSomethingNoparamhref((FacesEvent)event);
    }
     ...
     */
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public String showSomethingNoparamhref(final FacesEvent event)
    {
        String forward = null;
        final Object currentForm = this.resolveVariable("form");
        try
        {
            final ShowSomethingNoparamhrefFormImpl form =
                this.getShowSomethingNoparamhrefForm();
            form.setEvent(event);
            this.setForm("form", form, true);
            // - pass any properties from the previous form along
            FormPopulator.populateForm(currentForm, form);
            ...
            FormPopulator.populateFormFromPropertyMap(
                form, form.getDateTimeFormatters(), this.getContext().getExternalContext().getRequestParameterMap());
            //trigger method execution
            _showSomething_noparamhref(form);
     ...
     * @return forward
     */
    protected String _doSomething(final ShowSomethingNoparamhrefFormImpl form, String forward)
    {
        //this method can be overridden
        return forward;
    }
     ...
     * @throws Throwable
     */
    private String _doSomething(final ShowSomethingNoparamhrefFormImpl form)
        throws Throwable
    {
        String forward = null;
        forward = "hyperlinkactions-show-something";
    ...
    /**
     * Retrieves the {@link HyperlinkactionsFormImpl} form instance (normally you wont't
     * need to call this method explicitly, however this is here for times when you need to access the
     * <em>hyperlinkactionsHyperlinkactionsForm</em> instance outside of its assigned controller operation).
     * @return HyperlinkactionsFormImpl
     */
    protected HyperlinkactionsFormImpl getHyperlinkactionsForm()
    {
        // - we do this in the case a button that submitted the form was set to immediate (this should be removed
        //   when we found a better way to handle this).
        final UIForm uiForm = this.findForm(this.getContext().getViewRoot(), "hyperlinkactionsHyperlinkactionsForm");
        this.populateComponentInputs(uiForm);
        return (HyperlinkactionsFormImpl)this.resolveVariable("hyperlinkactionsHyperlinkactionsForm");
    }

    /**
     * This method is called when the use case 'Hyperlinkactions' starts.
     * It can be safely overridden in descendant classes.
HyperlinkactionsFormImpl)
     * @param form
     */
    protected void _hyperlinkactions_started(HyperlinkactionsFormImpl form)
    {
        //this method can be overridden
    }
     ...
     */
    public String hyperlinkactions()
    {
        return hyperlinkactions((FacesEvent)null);
    }

    /**
     * @param event
     */
    public void hyperlinkactions(final ActionEvent event)
    {
        this.hyperlinkactions((FacesEvent)event);
    }

    /**
     * @param event
     */
    public void hyperlinkactions(final ValueChangeEvent event)
    {
        this.hyperlinkactions((FacesEvent)event);
    }
     ...
     */
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public String hyperlinkactions(final FacesEvent event)
    {
        String forward = null;
        final Object currentForm = this.resolveVariable("form");
        try
        {
            final HyperlinkactionsFormImpl form =
                this.getHyperlinkactionsForm();
            form.setEvent(event);
            this.setForm("form", form, true);
            // - pass any properties from the previous form along
            FormPopulator.populateForm(currentForm, form);
            ...
            FormPopulator.populateFormFromPropertyMap(
                form, form.getDateTimeFormatters(), this.getContext().getExternalContext().getRequestParameterMap());
            //trigger method execution
            _hyperlinkactions_started(form);
     ...
     * @return forward
     */
    protected String _doSomething(final HyperlinkactionsFormImpl form, String forward)
    {
        //this method can be overridden
        return forward;
    }
     ...
     * @throws Throwable
     */
    private String _doSomething(final HyperlinkactionsFormImpl form)
        throws Throwable
    {
        String forward = null;
        forward = "hyperlinkactions-show-something";
