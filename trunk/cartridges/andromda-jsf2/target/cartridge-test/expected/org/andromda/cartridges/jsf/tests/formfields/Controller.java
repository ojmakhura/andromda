...
public abstract class Controller
    ...
    {
        // Resets all the "isSet" flags on the forms to false.
        this.getOneSubmitForm().resetIsSetFlags();
        this.getThreeGoForm().resetIsSetFlags();
        this.getFormFieldsForm().resetIsSetFlags();
    }

    /**
     * Retrieves the {@link OneSubmitFormImpl} form instance (normally you wont't
     ...
     * @return OneSubmitFormImpl
     */
    protected OneSubmitFormImpl getOneSubmitForm()
    {
        ...
        final UIForm uiForm = this.findForm(this.getContext().getViewRoot(), "formFieldsOneSubmitForm");
        this.populateComponentInputs(uiForm);
        return (OneSubmitFormImpl)this.resolveVariable("formFieldsOneSubmitForm");
    }

    /**
     * 
     * This method is called when 'submit' is triggered in the view 'one'.
     * It can be safely overridden in descendant classes.
OneSubmitFormImpl)
     * @param form
     */
    protected void _one_submit(OneSubmitFormImpl form)
    {
     ...
     * @return oneSubmit
     */
    public String oneSubmit()
    {
        return oneSubmit((FacesEvent)null);
    }

    /**
     * @param event
     */
    public void oneSubmit(final ActionEvent event)
    {
        this.oneSubmit((FacesEvent)event);
    }

    /**
     * @param event
     */
    public void oneSubmit(final ValueChangeEvent event)
    {
        this.oneSubmit((FacesEvent)event);
    }
    ...
    public String oneSubmit(final FacesEvent event)
    {
        String forward = null;
        final Object currentForm = this.resolveVariable("form");
        try
        {
            final OneSubmitFormImpl form =
            ...
            if (event != null)
            {
                FormFieldsViewPopulator.populateFormAndViewVariables(this.getContext(), form);
            }
        }
     ...
     * @return forward
     */
    protected String _two(final OneSubmitFormImpl form, String forward)
    {
        //this method can be overridden
        return forward;
    }
     ...
     * @throws Throwable
     */
    private String _two(final OneSubmitFormImpl form)
        throws Throwable
    {
        String forward = null;
        someOperation(form);
        forward = "form-fields-three";
        forward = _two(form, forward);
        return forward;
    }

    /**
     * Retrieves the {@link ThreeGoFormImpl} form instance (normally you wont't
     * need to call this method explicitly, however this is here for times when you need to access the
     * <em>formFieldsThreeGoForm</em> instance outside of its assigned controller operation).
     * @return ThreeGoFormImpl
     */
    protected ThreeGoFormImpl getThreeGoForm()
    {
        // - we do this in the case a button that submitted the form was set to immediate (this should be removed
        //   when we found a better way to handle this).
        final UIForm uiForm = this.findForm(this.getContext().getViewRoot(), "formFieldsThreeGoForm");
        this.populateComponentInputs(uiForm);
        return (ThreeGoFormImpl)this.resolveVariable("formFieldsThreeGoForm");
    }

    /**
     * 
     * This method is called when 'go' is triggered in the view 'three'.
     * It can be safely overridden in descendant classes.
ThreeGoFormImpl)
     * @param form
     */
    protected void _three_go(ThreeGoFormImpl form)
    {
        //this method can be overridden
    }
     ...
     * @return threeGo
     */
    public String threeGo()
    {
        return threeGo((FacesEvent)null);
    }

    /**
     * @param event
     */
    public void threeGo(final ActionEvent event)
    {
        this.threeGo((FacesEvent)event);
    }

    /**
     * @param event
     */
    public void threeGo(final ValueChangeEvent event)
    {
        this.threeGo((FacesEvent)event);
    }
     ...
     */
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public String threeGo(final FacesEvent event)
    {
        String forward = null;
        final Object currentForm = this.resolveVariable("form");
        try
        {
            final ThreeGoFormImpl form =
                this.getThreeGoForm();
            form.setEvent(event);
            this.setForm("form", form, true);
            // - pass any properties from the previous form along
    ...
    /**
     * Retrieves the {@link FormFieldsFormImpl} form instance (normally you wont't
     * need to call this method explicitly, however this is here for times when you need to access the
     * <em>formFieldsFormFieldsForm</em> instance outside of its assigned controller operation).
     * @return FormFieldsFormImpl
     */
    protected FormFieldsFormImpl getFormFieldsForm()
    {
        // - we do this in the case a button that submitted the form was set to immediate (this should be removed
        //   when we found a better way to handle this).
        final UIForm uiForm = this.findForm(this.getContext().getViewRoot(), "formFieldsFormFieldsForm");
        this.populateComponentInputs(uiForm);
        return (FormFieldsFormImpl)this.resolveVariable("formFieldsFormFieldsForm");
    }

    /**
     * This method is called when the use case 'FormFields' starts.
     * It can be safely overridden in descendant classes.
FormFieldsFormImpl)
     * @param form
     */
    protected void _formFields_started(FormFieldsFormImpl form)
    {
        //this method can be overridden
    }
    ...
    {
        return formFields((FacesEvent)null);
    }

    /**
     * @param event
     */
    public void formFields(final ActionEvent event)
    {
        this.formFields((FacesEvent)event);
    }

    /**
     * @param event
     */
    public void formFields(final ValueChangeEvent event)
    {
        this.formFields((FacesEvent)event);
    }
     ...
     */
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public String formFields(final FacesEvent event)
    {
        String forward = null;
        final Object currentForm = this.resolveVariable("form");
        try
        {
            final FormFieldsFormImpl form =
