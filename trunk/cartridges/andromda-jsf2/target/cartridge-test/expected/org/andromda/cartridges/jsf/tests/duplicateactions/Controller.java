...
public abstract class Controller
    ...
    {
        // Resets all the "isSet" flags on the forms to false.
        this.getShowSomethingSendForm().resetIsSetFlags();
        this.getShowSomethingSubmitForm().resetIsSetFlags();
        this.getShowSomethingSubmitForm().resetIsSetFlags();
        this.getDuplicateActionsUsecaseForm().resetIsSetFlags();
    }

    /**
     * Retrieves the {@link ShowSomethingSendFormImpl} form instance (normally you wont't
     * need to call this method explicitly, however this is here for times when you need to access the
     * <em>duplicateActionsUsecaseShowSomethingSendForm</em> instance outside of its assigned controller operation).
     * @return ShowSomethingSendFormImpl
     */
    protected ShowSomethingSendFormImpl getShowSomethingSendForm()
    {
        ...
        final UIForm uiForm = this.findForm(this.getContext().getViewRoot(), "duplicateActionsUsecaseShowSomethingSendForm");
        this.populateComponentInputs(uiForm);
        return (ShowSomethingSendFormImpl)this.resolveVariable("duplicateActionsUsecaseShowSomethingSendForm");
    }

    /**
     * 
     * This method is called when 'send' is triggered in the view 'show something'.
     * It can be safely overridden in descendant classes.
ShowSomethingSendFormImpl)
     * @param form
     */
    protected void _showSomething_send(ShowSomethingSendFormImpl form)
    {
        //this method can be overridden
    }

    /**
     * @return showSomethingSend
     */
    public String showSomethingSend()
    {
        return showSomethingSend((FacesEvent)null);
    }

    /**
     * @param event
     */
    public void showSomethingSend(final ActionEvent event)
    {
        this.showSomethingSend((FacesEvent)event);
    }

    /**
     * @param event
     */
    public void showSomethingSend(final ValueChangeEvent event)
    {
        this.showSomethingSend((FacesEvent)event);
    }
    ...
    public String showSomethingSend(final FacesEvent event)
    {
        String forward = null;
        final Object currentForm = this.resolveVariable("form");
        try
        {
            final ShowSomethingSendFormImpl form =
                this.getShowSomethingSendForm();
            form.setEvent(event);
            ...
            _showSomething_send(form);

            forward = _doSomething(form);
            ...
            if (event != null)
            {
                DuplicateActionsUsecaseViewPopulator.populateFormAndViewVariables(this.getContext(), form);
            }
        }
     ...
     * @return forward
     */
    protected String _doSomething(final ShowSomethingSendFormImpl form, String forward)
    {
        //this method can be overridden
        return forward;
    }
     ...
     * @throws Throwable
     */
    private String _doSomething(final ShowSomethingSendFormImpl form)
        throws Throwable
    {
        String forward = null;
        forward = "duplicate-actions-usecase-show-something";
        forward = _doSomething(form, forward);
        return forward;
    }

    /**
     * Retrieves the {@link ShowSomethingSubmitFormImpl} form instance (normally you wont't
     * need to call this method explicitly, however this is here for times when you need to access the
     * <em>duplicateActionsUsecaseShowSomethingSubmitForm</em> instance outside of its assigned controller operation).
     * @return ShowSomethingSubmitFormImpl
     */
    protected ShowSomethingSubmitFormImpl getShowSomethingSubmitForm()
    {
        // - we do this in the case a button that submitted the form was set to immediate (this should be removed
        //   when we found a better way to handle this).
        final UIForm uiForm = this.findForm(this.getContext().getViewRoot(), "duplicateActionsUsecaseShowSomethingSubmitForm");
        this.populateComponentInputs(uiForm);
        return (ShowSomethingSubmitFormImpl)this.resolveVariable("duplicateActionsUsecaseShowSomethingSubmitForm");
    }

    /**
     * 
     * This method is called when 'submit' is triggered in the view 'show something'.
     * It can be safely overridden in descendant classes.
ShowSomethingSubmitFormImpl)
     * @param form
     */
    protected void _showSomething_submit(ShowSomethingSubmitFormImpl form)
    {
        //this method can be overridden
    }

    /**
     * @return showSomethingSubmit
     */
    public String showSomethingSubmit()
    {
        return showSomethingSubmit((FacesEvent)null);
    }

    /**
     * @param event
     */
    public void showSomethingSubmit(final ActionEvent event)
    {
        this.showSomethingSubmit((FacesEvent)event);
    }

    /**
     * @param event
     */
    public void showSomethingSubmit(final ValueChangeEvent event)
    {
        this.showSomethingSubmit((FacesEvent)event);
    }
     ...
     */
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public String showSomethingSubmit(final FacesEvent event)
    {
        String forward = null;
        final Object currentForm = this.resolveVariable("form");
        try
        {
            final ShowSomethingSubmitFormImpl form =
                this.getShowSomethingSubmitForm();
            form.setEvent(event);
            this.setForm("form", form, true);
            // - pass any properties from the previous form along
            FormPopulator.populateForm(currentForm, form);
     ...
     * @return forward
     */
    protected String _doSomething(final ShowSomethingSubmitFormImpl form, String forward)
    {
        //this method can be overridden
        return forward;
    }
     ...
     * @throws Throwable
     */
    private String _doSomething(final ShowSomethingSubmitFormImpl form)
        throws Throwable
    {
        String forward = null;
        forward = "duplicate-actions-usecase-show-something";
...
ShowSomethingSubmitFormImpl)
     ...
     * @return forward
     */
    protected String _doSomethingElse(final ShowSomethingSubmitFormImpl form, String forward)
    {
        //this method can be overridden
        return forward;
    }
     ...
     * @throws Throwable
     */
    private String _doSomethingElse(final ShowSomethingSubmitFormImpl form)
        throws Throwable
    {
        String forward = null;
        forward = _doSomething(form);
    ...
    /**
     * Retrieves the {@link DuplicateActionsUsecaseFormImpl} form instance (normally you wont't
     * need to call this method explicitly, however this is here for times when you need to access the
     * <em>duplicateActionsUsecaseDuplicateActionsUsecaseForm</em> instance outside of its assigned controller operation).
     * @return DuplicateActionsUsecaseFormImpl
     */
    protected DuplicateActionsUsecaseFormImpl getDuplicateActionsUsecaseForm()
    {
        // - we do this in the case a button that submitted the form was set to immediate (this should be removed
        //   when we found a better way to handle this).
        final UIForm uiForm = this.findForm(this.getContext().getViewRoot(), "duplicateActionsUsecaseDuplicateActionsUsecaseForm");
        this.populateComponentInputs(uiForm);
        return (DuplicateActionsUsecaseFormImpl)this.resolveVariable("duplicateActionsUsecaseDuplicateActionsUsecaseForm");
    }

    /**
     * This method is called when the use case 'DuplicateActions usecase' starts.
     * It can be safely overridden in descendant classes.
DuplicateActionsUsecaseFormImpl)
     * @param form
     */
    protected void _duplicateActionsUsecase_started(DuplicateActionsUsecaseFormImpl form)
    {
        //this method can be overridden
    }

    /**
     * @return duplicateActionsUsecase
     */
    public String duplicateActionsUsecase()
    {
        return duplicateActionsUsecase((FacesEvent)null);
    }

    /**
     * @param event
     */
    public void duplicateActionsUsecase(final ActionEvent event)
    {
        this.duplicateActionsUsecase((FacesEvent)event);
    }

    /**
     * @param event
     */
    public void duplicateActionsUsecase(final ValueChangeEvent event)
    {
        this.duplicateActionsUsecase((FacesEvent)event);
    }
     ...
     */
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public String duplicateActionsUsecase(final FacesEvent event)
    {
        String forward = null;
        final Object currentForm = this.resolveVariable("form");
        try
        {
            final DuplicateActionsUsecaseFormImpl form =
                this.getDuplicateActionsUsecaseForm();
            form.setEvent(event);
            this.setForm("form", form, true);
            // - pass any properties from the previous form along
            FormPopulator.populateForm(currentForm, form);
            ...
            FormPopulator.populateFormFromPropertyMap(
                form, form.getDateTimeFormatters(), this.getContext().getExternalContext().getRequestParameterMap());
            //trigger method execution
            _duplicateActionsUsecase_started(form);
     ...
     * @return forward
     */
    protected String _doSomething(final DuplicateActionsUsecaseFormImpl form, String forward)
    {
        //this method can be overridden
        return forward;
    }
     ...
     * @throws Throwable
     */
    private String _doSomething(final DuplicateActionsUsecaseFormImpl form)
        throws Throwable
    {
        String forward = null;
        forward = "duplicate-actions-usecase-show-something";
