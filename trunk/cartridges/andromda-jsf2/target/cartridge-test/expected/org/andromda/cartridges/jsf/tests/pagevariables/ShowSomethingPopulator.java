    ...
    implements Filter
{
        ...
        throws ServletException
    {
        ...
        try
        {
            ...
            if (form != null)
            {
                ShowSomethingSubmitFormImpl pageVariablesShowSomethingSubmitForm =
                    (ShowSomethingSubmitFormImpl)variableResolver.resolveVariable(
                    facesContext,
                    "pageVariablesShowSomethingSubmitForm");
                // - populate the pageVariablesShowSomethingSubmitForm with any parameters from the previous form
                FormPopulator.populateForm(form, pageVariablesShowSomethingSubmitForm, false);
                request.setAttribute("pageVariablesShowSomethingSubmitForm", pageVariablesShowSomethingSubmitForm);
            }
            // - serialize the form
            if (form != null)
            {
            ...
            if (form != null)
            {
                final boolean aReadable = PropertyUtils.isReadable(form, "a");
                if (aReadable)
                {
                    Boolean propertySet = null;
                    final String isSetPropertyName = "aSet";
                    ...
                    {
                        request.setAttribute("a", PropertyUtils.getProperty(form, "a"));
                    }
                }
                final boolean bReadable = PropertyUtils.isReadable(form, "b");
                if (bReadable)
                {
                    Boolean propertySet = null;
                    final String isSetPropertyName = "bSet";
                    if (PropertyUtils.isReadable(form, isSetPropertyName))
                    {
                        propertySet = (Boolean)PropertyUtils.getProperty(form, isSetPropertyName);
                    }
                    ...
                    if (propertySet == null || propertySet.booleanValue())
                    {
                        request.setAttribute("b", PropertyUtils.getProperty(form, "b"));
                    }
                }
                final boolean cReadable = PropertyUtils.isReadable(form, "c");
                if (cReadable)
                {
                    Boolean propertySet = null;
                    final String isSetPropertyName = "cSet";
                    if (PropertyUtils.isReadable(form, isSetPropertyName))
                    {
                        propertySet = (Boolean)PropertyUtils.getProperty(form, isSetPropertyName);
                    }
                    ...
                    if (propertySet == null || propertySet.booleanValue())
                    {
                        request.setAttribute("c", PropertyUtils.getProperty(form, "c"));
                    }
                }
            }
        }
