...
public final class InterActionStateViewPopulator
{
    ...
    static
    {
        populators.put("/org/andromda/cartridges/jsf/tests/interactionstate/page1.xhtml", Page1Populator.class);
        populators.put("/org/andromda/cartridges/jsf/tests/interactionstate/page1.jsf", Page1Populator.class);
    }
}