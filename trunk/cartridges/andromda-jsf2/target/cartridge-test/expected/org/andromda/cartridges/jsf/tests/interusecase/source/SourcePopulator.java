...
/**
 * This filter handles the population of forms for the <em>source</code>
 * view.
 */
public class SourcePopulator
    implements Filter
{
        ...
        throws ServletException
    {
        ...
        try
        {
            ...
            if (form != null)
            {
                SourceSubmitFormImpl interUseCaseSourceSourceSubmitForm =
                    (SourceSubmitFormImpl)variableResolver.resolveVariable(
                    facesContext,
                    "interUseCaseSourceSourceSubmitForm");
                // - populate the interUseCaseSourceSourceSubmitForm with any parameters from the previous form
                FormPopulator.populateForm(form, interUseCaseSourceSourceSubmitForm, false);
                request.setAttribute("interUseCaseSourceSourceSubmitForm", interUseCaseSourceSourceSubmitForm);
            }
            // - serialize the form
            if (form != null)
            {
