 ...
 * a URL call.
 */
public class JspsCannotDeferCanStop
    extends HttpServlet
{
    /**  */
        ...
        throws ServletException, IOException
    {
        ...
        Controller controller =
            (Controller)FacesContextUtils.resolveVariable(
                request, response,
                "controller");
        final String forwardPath = UseCaseForwards.getPath(controller.jspsCannotDeferCanStop());
        if(forwardPath != null){
            JspsCannotDeferCanStopViewPopulator.populateFormAndViewVariables(
