...
public abstract class Controller
    ...
    /**
     * This method is called when the use case 'Hyperlinked' starts.
     * It can be safely overridden in descendant classes.
     */
    protected void _hyperlinked_started()
    {
     ...
     * @return hyperlinked
     */
    public String hyperlinked()
    {
        return hyperlinked((javax.faces.event.FacesEvent)null);
    }

    /**
     * @param event
     */
    public void hyperlinked(final ActionEvent event)
    {
        this.hyperlinked((javax.faces.event.FacesEvent)event);
    }

    /**
     * @param event
     */
    public void hyperlinked(final javax.faces.event.ValueChangeEvent event)
    {
        this.hyperlinked((javax.faces.event.FacesEvent)event);
    }
     ...
     * @return hyperlinked
     */
    public String hyperlinked(final javax.faces.event.FacesEvent event)
    {
        String forward = null;
