...
/**
 * This filter handles the population of forms for the <em>Reset page</code>
 * view.
 */
public class ResetPagePopulator
    implements Filter
{
        ...
        throws ServletException
    {
        ...
        try
        {
            ...
            if (form != null)
            {
                ResetPageSendWithResetFormImpl resetResetPageSendWithResetForm =
                    (ResetPageSendWithResetFormImpl)variableResolver.resolveVariable(
                    facesContext,
                    "resetResetPageSendWithResetForm");
                // - populate the resetResetPageSendWithResetForm with any parameters from the previous form
                FormPopulator.populateForm(form, resetResetPageSendWithResetForm, false);
                request.setAttribute("resetResetPageSendWithResetForm", resetResetPageSendWithResetForm);
            }
            // - serialize the form
            if (form != null)
            {
