...
public final class NoTableLinkActivityViewPopulator
{
    ...
    static
    {
        populators.put("/org/andromda/cartridges/jsf/tests/tables/notablelink/show-table-data.xhtml", ShowTableDataPopulator.class);
        populators.put("/org/andromda/cartridges/jsf/tests/tables/notablelink/show-table-data.jsf", ShowTableDataPopulator.class);
    }
}