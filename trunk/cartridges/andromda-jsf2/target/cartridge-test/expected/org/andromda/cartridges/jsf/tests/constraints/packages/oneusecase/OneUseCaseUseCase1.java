 ...
 * a URL call.
 */
public class OneUseCaseUseCase1
    extends HttpServlet
{
    /**  */
        ...
        throws ServletException, IOException
    {
        ...
        Controller1 controller =
            (Controller1)FacesContextUtils.resolveVariable(
                request, response,
                "controller1");
        final String forwardPath = UseCaseForwards.getPath(controller.oneUseCaseUseCase1());
        if(forwardPath != null){
