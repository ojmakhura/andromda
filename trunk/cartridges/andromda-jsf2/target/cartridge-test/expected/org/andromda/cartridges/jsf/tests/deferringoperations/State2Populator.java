...
/**
 * This filter handles the population of forms for the <em>state2</code>
 * view.
 */
public class State2Populator
    implements Filter
{
        ...
        throws ServletException
    {
        ...
        try
        {
            ...
            if (form != null)
            {
                State2Trigger2FormImpl deferringOperationsState2Trigger2Form =
                    (State2Trigger2FormImpl)variableResolver.resolveVariable(
                    facesContext,
                    "deferringOperationsState2Trigger2Form");
                // - populate the deferringOperationsState2Trigger2Form with any parameters from the previous form
                FormPopulator.populateForm(form, deferringOperationsState2Trigger2Form, false);
                request.setAttribute("deferringOperationsState2Trigger2Form", deferringOperationsState2Trigger2Form);
                State2Trigger2bFormImpl deferringOperationsState2Trigger2bForm =
                    (State2Trigger2bFormImpl)variableResolver.resolveVariable(
                    facesContext,
                    "deferringOperationsState2Trigger2bForm");
                // - populate the deferringOperationsState2Trigger2bForm with any parameters from the previous form
                FormPopulator.populateForm(form, deferringOperationsState2Trigger2bForm, false);
                request.setAttribute("deferringOperationsState2Trigger2bForm", deferringOperationsState2Trigger2bForm);
            }
            // - serialize the form
            if (form != null)
            {
            ...
            if (form != null)
            {
                final boolean pageVariableReadable = PropertyUtils.isReadable(form, "pageVariable");
                if (pageVariableReadable)
                {
                    Boolean propertySet = null;
                    final String isSetPropertyName = "pageVariableSet";
                    ...
                    {
                        request.setAttribute("pageVariable", PropertyUtils.getProperty(form, "pageVariable"));
                    }
                }
            }
        }
