        ...
        throws ServletException, IOException
    {
        ...
        Controller controller =
            (Controller)FacesContextUtils.resolveVariable(
                request, response,
                "controller");
        final String forwardPath = UseCaseForwards.getPath(controller.widgetsActivity());
        if(forwardPath != null){
            WidgetsActivityViewPopulator.populateFormAndViewVariables(
