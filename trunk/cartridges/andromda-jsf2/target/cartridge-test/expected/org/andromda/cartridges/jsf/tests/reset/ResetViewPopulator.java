...
public final class ResetViewPopulator
{
    ...
    static
    {
        populators.put("/org/andromda/cartridges/jsf/tests/reset/reset-page.xhtml", ResetPagePopulator.class);
        populators.put("/org/andromda/cartridges/jsf/tests/reset/reset-page.jsf", ResetPagePopulator.class);
    }
}