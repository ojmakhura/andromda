...
public abstract class Controller
    ...
    {
        // Resets all the "isSet" flags on the forms to false.
        this.getEnterDataValidateForm().resetIsSetFlags();
        this.getValidationActivityForm().resetIsSetFlags();
    }

    /**
     * Retrieves the {@link org.andromda.cartridges.jsf.tests.validation.EnterDataValidateFormImpl} form instance (normally you wont't
     * need to call this method explicitly, however this is here for times when you need to access the
     * <em>validationActivityEnterDataValidateForm</em> instance outside of its assigned controller operation).
     * @return org.andromda.cartridges.jsf.tests.validation.EnterDataValidateFormImpl
     */
    protected org.andromda.cartridges.jsf.tests.validation.EnterDataValidateFormImpl getEnterDataValidateForm()
    {
        ...
        final javax.faces.component.UIForm uiForm = this.findForm(this.getContext().getViewRoot(), "validationActivityEnterDataValidateForm");
        this.populateComponentInputs(uiForm);
        return (org.andromda.cartridges.jsf.tests.validation.EnterDataValidateFormImpl)this.resolveVariable("validationActivityEnterDataValidateForm");
    }

    /**
     * 
     * This method is called when 'validate' is triggered in the view 'enter data'.
     * It can be safely overridden in descendant classes.
org.andromda.cartridges.jsf.tests.validation.EnterDataValidateFormImpl)
     * @param form
     */
    protected void _enterData_validate(org.andromda.cartridges.jsf.tests.validation.EnterDataValidateFormImpl form)
    {
        //this method can be overridden
    }

    /**
     * @return enterDataValidate
     */
    public String enterDataValidate()
    {
        return enterDataValidate((javax.faces.event.FacesEvent)null);
    }

    /**
     * @param event
     */
    public void enterDataValidate(final ActionEvent event)
    {
        this.enterDataValidate((javax.faces.event.FacesEvent)event);
    }

    /**
     * @param event
     */
    public void enterDataValidate(final javax.faces.event.ValueChangeEvent event)
    {
        this.enterDataValidate((javax.faces.event.FacesEvent)event);
    }
    ...
    public String enterDataValidate(final javax.faces.event.FacesEvent event)
    {
        String forward = null;
        final Object currentForm = this.resolveVariable("form");
        try
        {
            final org.andromda.cartridges.jsf.tests.validation.EnterDataValidateFormImpl form =
                this.getEnterDataValidateForm();
            form.setEvent(event);
            ...
            _enterData_validate(form);

            forward = _validateData(form);
            ...
            if (event != null)
            {
                ValidationActivityViewPopulator.populateFormAndViewVariables(this.getContext(), form);
            }
        }
     ...
     * @return forward
     */
    protected String _validateData(final org.andromda.cartridges.jsf.tests.validation.EnterDataValidateFormImpl form, String forward)
    {
        //this method can be overridden
        return forward;
    }
     ...
     * @throws Throwable
     */
    private String _validateData(final org.andromda.cartridges.jsf.tests.validation.EnterDataValidateFormImpl form)
        throws Throwable
    {
        String forward = null;
        ...
        forward = _validateData(form, forward);
        return forward;
    }

    /**
     * Retrieves the {@link org.andromda.cartridges.jsf.tests.validation.ValidationActivityFormImpl} form instance (normally you wont't
     * need to call this method explicitly, however this is here for times when you need to access the
     * <em>validationActivityValidationActivityForm</em> instance outside of its assigned controller operation).
     * @return org.andromda.cartridges.jsf.tests.validation.ValidationActivityFormImpl
     */
    protected org.andromda.cartridges.jsf.tests.validation.ValidationActivityFormImpl getValidationActivityForm()
    {
        // - we do this in the case a button that submitted the form was set to immediate (this should be removed
        //   when we found a better way to handle this).
        final javax.faces.component.UIForm uiForm = this.findForm(this.getContext().getViewRoot(), "validationActivityValidationActivityForm");
        this.populateComponentInputs(uiForm);
        return (org.andromda.cartridges.jsf.tests.validation.ValidationActivityFormImpl)this.resolveVariable("validationActivityValidationActivityForm");
    }

    /**
     * This method is called when the use case 'Validation Activity' starts.
     * It can be safely overridden in descendant classes.
org.andromda.cartridges.jsf.tests.validation.ValidationActivityFormImpl)
     * @param form
     */
    protected void _validationActivity_started(org.andromda.cartridges.jsf.tests.validation.ValidationActivityFormImpl form)
    {
        //this method can be overridden
    }
    ...
    {
        return validationActivity((javax.faces.event.FacesEvent)null);
    }

    /**
     * @param event
     */
    public void validationActivity(final ActionEvent event)
    {
        this.validationActivity((javax.faces.event.FacesEvent)event);
    }

    /**
     * @param event
     */
    public void validationActivity(final javax.faces.event.ValueChangeEvent event)
    {
        this.validationActivity((javax.faces.event.FacesEvent)event);
    }
     ...
     */
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public String validationActivity(final javax.faces.event.FacesEvent event)
    {
        String forward = null;
        final Object currentForm = this.resolveVariable("form");
        try
        {
            final org.andromda.cartridges.jsf.tests.validation.ValidationActivityFormImpl form =
                this.getValidationActivityForm();
            form.setEvent(event);
            this.setForm("form", form, true);
            // - pass any properties from the previous form along
            org.andromda.presentation.jsf.FormPopulator.populateForm(currentForm, form);
            ...
            org.andromda.presentation.jsf.FormPopulator.populateFormFromPropertyMap(
                form, form.getDateTimeFormatters(), this.getContext().getExternalContext().getRequestParameterMap());
            //trigger method execution
            _validationActivity_started(form);
     ...
     * @return forward
     */
    protected String _preloading(final org.andromda.cartridges.jsf.tests.validation.ValidationActivityFormImpl form, String forward)
    {
        //this method can be overridden
        return forward;
    }
     ...
     * @throws Throwable
     */
    private String _preloading(final org.andromda.cartridges.jsf.tests.validation.ValidationActivityFormImpl form)
        throws Throwable
    {
        String forward = null;
        forward = "validation-activity-enter-data";
