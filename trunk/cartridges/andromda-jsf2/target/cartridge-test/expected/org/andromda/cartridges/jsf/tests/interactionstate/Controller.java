...
public abstract class Controller
    ...
    {
        // Resets all the "isSet" flags on the forms to false.
        this.getPage1SubmitForm().resetIsSetFlags();
        this.getInterActionStateForm().resetIsSetFlags();
    }

    /**
     * Retrieves the {@link Page1SubmitFormImpl} form instance (normally you wont't
     * need to call this method explicitly, however this is here for times when you need to access the
     * <em>interActionStatePage1SubmitForm</em> instance outside of its assigned controller operation).
     * @return Page1SubmitFormImpl
     */
    protected Page1SubmitFormImpl getPage1SubmitForm()
    {
        ...
        final UIForm uiForm = this.findForm(this.getContext().getViewRoot(), "interActionStatePage1SubmitForm");
        this.populateComponentInputs(uiForm);
        return (Page1SubmitFormImpl)this.resolveVariable("interActionStatePage1SubmitForm");
    }

    /**
     * 
     * This method is called when 'submit' is triggered in the view 'page1'.
     * It can be safely overridden in descendant classes.
Page1SubmitFormImpl)
     * @param form
     */
    protected void _page1_submit(Page1SubmitFormImpl form)
    {
     ...
     * @return page1Submit
     */
    public String page1Submit()
    {
        return page1Submit((FacesEvent)null);
    }

    /**
     * @param event
     */
    public void page1Submit(final ActionEvent event)
    {
        this.page1Submit((FacesEvent)event);
    }

    /**
     * @param event
     */
    public void page1Submit(final ValueChangeEvent event)
    {
        this.page1Submit((FacesEvent)event);
    }
    ...
    public String page1Submit(final FacesEvent event)
    {
        String forward = null;
        final Object currentForm = this.resolveVariable("form");
        try
        {
            final Page1SubmitFormImpl form =
                this.getPage1SubmitForm();
            form.setEvent(event);
            ...
            if (event != null)
            {
                InterActionStateViewPopulator.populateFormAndViewVariables(this.getContext(), form);
            }
        }
     ...
     * @return forward
     */
    protected String _stateA(final Page1SubmitFormImpl form, String forward)
    {
        //this method can be overridden
        return forward;
    }
     ...
     * @throws Throwable
     */
    private String _stateA(final Page1SubmitFormImpl form)
        throws Throwable
    {
        String forward = null;
        forward = _stateB(form);
        forward = _stateA(form, forward);
        return forward;
    }
     ...
     * @return forward
     */
    protected String _stateB(final Page1SubmitFormImpl form, String forward)
    {
        //this method can be overridden
        return forward;
    }
     ...
     * @throws Throwable
     */
    private String _stateB(final Page1SubmitFormImpl form)
        throws Throwable
    {
        String forward = null;
        forward = "inter-action-state-page1";
        forward = _stateB(form, forward);
        return forward;
    }

    /**
     * Retrieves the {@link InterActionStateFormImpl} form instance (normally you wont't
     * need to call this method explicitly, however this is here for times when you need to access the
     * <em>interActionStateInterActionStateForm</em> instance outside of its assigned controller operation).
     * @return InterActionStateFormImpl
     */
    protected InterActionStateFormImpl getInterActionStateForm()
    {
        // - we do this in the case a button that submitted the form was set to immediate (this should be removed
        //   when we found a better way to handle this).
        final UIForm uiForm = this.findForm(this.getContext().getViewRoot(), "interActionStateInterActionStateForm");
        this.populateComponentInputs(uiForm);
        return (InterActionStateFormImpl)this.resolveVariable("interActionStateInterActionStateForm");
    }

    /**
     * This method is called when the use case 'InterActionState' starts.
     * It can be safely overridden in descendant classes.
InterActionStateFormImpl)
     * @param form
     */
    protected void _interActionState_started(InterActionStateFormImpl form)
    {
        //this method can be overridden
    }
    ...
    {
        return interActionState((FacesEvent)null);
    }

    /**
     * @param event
     */
    public void interActionState(final ActionEvent event)
    {
        this.interActionState((FacesEvent)event);
    }

    /**
     * @param event
     */
    public void interActionState(final ValueChangeEvent event)
    {
        this.interActionState((FacesEvent)event);
    }
     ...
     */
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public String interActionState(final FacesEvent event)
    {
        String forward = null;
        final Object currentForm = this.resolveVariable("form");
        try
        {
            final InterActionStateFormImpl form =
                this.getInterActionStateForm();
            form.setEvent(event);
            this.setForm("form", form, true);
            // - pass any properties from the previous form along
            FormPopulator.populateForm(currentForm, form);
            ...
            FormPopulator.populateFormFromPropertyMap(
                form, form.getDateTimeFormatters(), this.getContext().getExternalContext().getRequestParameterMap());
            //trigger method execution
            _interActionState_started(form);
