...
public abstract class Controller
    ...
    /**
     * 
     * This method is called when 'a' is triggered in the view 'something'.
     * It can be safely overridden in descendant classes.
     */
    protected void _something_a()
    {
    ...
    {
        return somethingA((javax.faces.event.FacesEvent)null);
    }

    /**
     * @param event
     */
    public void somethingA(final ActionEvent event)
    {
        this.somethingA((javax.faces.event.FacesEvent)event);
    }

    /**
     * @param event
     */
    public void somethingA(final javax.faces.event.ValueChangeEvent event)
    {
        this.somethingA((javax.faces.event.FacesEvent)event);
    }
     ...
     * @return somethingA
     */
    public String somethingA(final javax.faces.event.FacesEvent event)
    {
    ...
    /**
     * 
     * This method is called when 'b' is triggered in the view 'something'.
     * It can be safely overridden in descendant classes.
     */
    protected void _something_b()
    {
        //this method can be overridden
    }
    ...
    {
        return somethingB((javax.faces.event.FacesEvent)null);
    }

    /**
     * @param event
     */
    public void somethingB(final ActionEvent event)
    {
        this.somethingB((javax.faces.event.FacesEvent)event);
    }

    /**
     * @param event
     */
    public void somethingB(final javax.faces.event.ValueChangeEvent event)
    {
        this.somethingB((javax.faces.event.FacesEvent)event);
    }
     ...
     * @return somethingB
     */
    public String somethingB(final javax.faces.event.FacesEvent event)
    {
        $targetUseCase.controller.fullyQualifiedName controller =
            ($targetUseCase.controller.fullyQualifiedName)this.resolveVariable(
                "$targetUseCase.controller.beanName");
    ...
    /**
     * 
     * This method is called when 'c' is triggered in the view 'something'.
     * It can be safely overridden in descendant classes.
     */
    protected void _something_c()
    {
        //this method can be overridden
    }
     ...
     * @return somethingC
     */
    public String somethingC()
    {
        return somethingC((javax.faces.event.FacesEvent)null);
    }

    /**
     * @param event
     */
    public void somethingC(final ActionEvent event)
    {
        this.somethingC((javax.faces.event.FacesEvent)event);
    }

    /**
     * @param event
     */
    public void somethingC(final javax.faces.event.ValueChangeEvent event)
    {
        this.somethingC((javax.faces.event.FacesEvent)event);
    }
     ...
     * @return somethingC
     */
    public String somethingC(final javax.faces.event.FacesEvent event)
    {
        $targetUseCase.controller.fullyQualifiedName controller =
            ($targetUseCase.controller.fullyQualifiedName)this.resolveVariable(
                "$targetUseCase.controller.beanName");
    ...
    /**
     * 
     * This method is called when 'd' is triggered in the view 'something'.
     * It can be safely overridden in descendant classes.
     */
    protected void _something_d()
    {
        //this method can be overridden
    }
     ...
     * @return somethingD
     */
    public String somethingD()
    {
        return somethingD((javax.faces.event.FacesEvent)null);
    }

    /**
     * @param event
     */
    public void somethingD(final ActionEvent event)
    {
        this.somethingD((javax.faces.event.FacesEvent)event);
    }

    /**
     * @param event
     */
    public void somethingD(final javax.faces.event.ValueChangeEvent event)
    {
        this.somethingD((javax.faces.event.FacesEvent)event);
    }
     ...
     * @return somethingD
     */
    public String somethingD(final javax.faces.event.FacesEvent event)
    {
        $targetUseCase.controller.fullyQualifiedName controller =
            ($targetUseCase.controller.fullyQualifiedName)this.resolveVariable(
                "$targetUseCase.controller.beanName");
    ...
    /**
     * This method is called when the use case 'FinalStatesWebPage' starts.
     * It can be safely overridden in descendant classes.
     */
    protected void _finalStatesWebPage_started()
    {
        //this method can be overridden
    }

    /**
     * @return finalStatesWebPage
     */
    public String finalStatesWebPage()
    {
        return finalStatesWebPage((javax.faces.event.FacesEvent)null);
    }

    /**
     * @param event
     */
    public void finalStatesWebPage(final ActionEvent event)
    {
        this.finalStatesWebPage((javax.faces.event.FacesEvent)event);
    }

    /**
     * @param event
     */
    public void finalStatesWebPage(final javax.faces.event.ValueChangeEvent event)
    {
        this.finalStatesWebPage((javax.faces.event.FacesEvent)event);
    }
     ...
     * @return finalStatesWebPage
     */
    public String finalStatesWebPage(final javax.faces.event.FacesEvent event)
    {
        String forward = null;
        ...
        try
        {
            ...
            _finalStatesWebPage_started();

            forward = "final-states-web-page-something";
            ...
            if (event != null)
            {
                FinalStatesWebPageViewPopulator.populateFormAndViewVariables(this.getContext(), null);
            }
        }
