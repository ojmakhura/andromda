 ...
 * a URL call.
 */
public class DecisionsBadTarget
    extends HttpServlet
{
    /**  */
        ...
        throws ServletException, IOException
    {
        ...
        Controller controller =
            (Controller)FacesContextUtils.resolveVariable(
                request, response,
                "controller");
        final String forwardPath = UseCaseForwards.getPath(controller.decisionsBadTarget());
        if(forwardPath != null){
            DecisionsBadTargetViewPopulator.populateFormAndViewVariables(
