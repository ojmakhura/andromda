 ...
 * MetafacadeLogic for JSFSessionObject
 *
 * @see JSFSessionObject
 */
public abstract class JSFSessionObjectLogic
    extends MetafacadeBase
    implements JSFSessionObject
{
    /**
     ...
     * @param context
     */
    protected JSFSessionObjectLogic(Object metaObjectIn, String context)
    {
     ...
     * @param context String. Set to JSFSessionObject if null
    ...
    private static String getContext(String context)
    {
        if (context == null)
        {
            context = "org.andromda.cartridges.jsf2.metafacades.JSFSessionObject";
        }
        return context;
    }
