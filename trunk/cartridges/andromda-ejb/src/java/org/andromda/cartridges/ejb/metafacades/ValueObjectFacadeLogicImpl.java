    ...
    extends ValueObjectFacadeLogic
{
    ...
    {
        String packageName = MessageFormat.format(this.getConfiguredProperty(
            "valueObjectPackage").toString(), new String[]
        {
    ...
    {
        return MessageFormat.format(this.getConfiguredProperty(
            "valueObjectName").toString(), new Object[]
        {
    ...
    public String getFullyQualifiedName()
    {
        ...
        return (fqn == null || fqn.equalsIgnoreCase("")) ? getName() : fqn
            + "." + getName();
    }

    /**
     * If we're using inheritance to build up a value object with all model
     * elements of an entity, we're returning no superclass.
     */
    public GeneralizableElementFacade getGeneralization()
    {
        GeneralizableElementFacade gef = super.getGeneralization();
        return (gef == null || gef.hasStereotype(EJBProfile.STEREOTYPE_ENTITY))
            ? null
            : gef;
    }
}