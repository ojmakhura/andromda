...
public class MetafacadeUtils
{
     ...
     * relation may appear with the name Customer-Address. But if you are in the
     * Address entity looking at the Customer then you will get an error because
     * the relation will be called Address-Customer. A simple way to guarantee
