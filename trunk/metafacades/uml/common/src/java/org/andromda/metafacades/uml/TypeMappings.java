...
/**
 * <p>
 * An object responsible for mapping types in the object model to other language
 * identifiers/types. (For example, Java, SQL, Jdbc, etc).  Basically just
 * wraps the core {@link Mappings} instance in order to provide type specific
...
{   
    ...
    /**
     * The constructor that takes the {@link Mappings}
     * instance.
     * 
     * @param mappings the Mapping instance from which to 
     *        construct this TypeMappings instance.
     */
     ...
     * 
     * @param arraySuffix the suffix used for arrays within
     *        this mapping.
     */
    ...
    /**
     * Returns a new configured instance of this TypeMappings configured from the
     * mappings instance.
     * 
    ...
    /**
     * Returns a new configured instance of this TypeMappings configured from
     * the mappings instance.
     * 
     * @param mappingsUri the URI to configure the underlying {@link Mappings}
     *        instance.
     * @return TypeMappings the configured TypeMappings instance.
    ...
    /**
     * The suffix appended to array types is set from 
     * {@link #setArraySuffix(String)}.
     */
