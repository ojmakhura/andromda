...
/**
 * MetafacadeLogic implementation for org.andromda.cartridges.bpm4jsf.metafacades.JSFControllerOperation.
 *
 * @see org.andromda.cartridges.bpm4jsf.metafacades.JSFControllerOperation
 */
    ...
    extends JSFControllerOperationLogic
{
    ...
    /**
     * @see org.andromda.cartridges.bpm4jsf.metafacades.JSFControllerOperation#getFormName()
     */
    protected java.lang.String handleGetFormName()
    {
        final String pattern = ObjectUtils.toString(this.getConfiguredProperty(BPM4JSFGlobals.FORM_PATTERN));
        return pattern.replaceFirst("\\{0\\}", StringUtils.capitalize(this.getName()));
    }

    /**
     * @see org.andromda.cartridges.bpm4jsf.metafacades.JSFControllerOperation#getFullyQualifiedFormName()
     */
    ...
    /**
     * @see org.andromda.cartridges.bpm4jsf.metafacades.JSFControllerOperation#getFullyQualifiedFormPath()
     */
    ...
    /**
     * @see org.andromda.cartridges.bpm4jsf.metafacades.JSFControllerOperation#getFormCall()
     */
    ...
    /**
     * @see org.andromda.cartridges.bpm4jsf.metafacades.JSFControllerOperation#getmplementationFormSignature()
     */
    ...
    /**
     * @see org.andromda.cartridges.bpm4jsf.metafacades.JSFControllerOperation#getFormSignature()
     */
