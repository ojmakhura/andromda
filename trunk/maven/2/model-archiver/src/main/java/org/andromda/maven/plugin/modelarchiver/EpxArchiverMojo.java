    ...
    extends AbstractMojo
{
    ...
    /**
     * The directory for the generated epx.
     *
    ...
    /**
     * The name of the epx file to generate.
     *
        ...
        throws MojoExecutionException
    {
        ...
        try
        {
            ...
            {
                getLog().info("Copy epx resources to " + buildDirectory.getAbsolutePath());
            ...
            final File epxFile = new File(buildDirectory, this.finalName + ".epx");
