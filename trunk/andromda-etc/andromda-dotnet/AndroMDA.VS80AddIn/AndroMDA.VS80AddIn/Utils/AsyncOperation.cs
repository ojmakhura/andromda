...
// AsyncOperation.cs - A base class for cancellable operations
...
namespace AndroMDA.VS80AddIn
{
    ...
    public abstract class AsyncOperation
    {
        ...
        protected void AcknowledgeCancel()
        {
            lock (this)
            {
				...
				*/
				...
				FireAsync(Cancelled, this, EventArguments);
            }
        }
		...
		protected EventArgs EventArguments
		{
			get { lock (this) { return eventArguments; } }
			set { lock (this) { eventArguments = value; } }
		}				
        ...
        private void CompleteOperation()
        {
            lock (this)
            {
                ...
                // Async.
                FireAsync(Completed, this, EventArguments);
            }
        }
        ...
        protected void FireAsync(Delegate dlg, params object[] pList)
        {
            if (dlg != null)
            {
				if (Target is Control)
					...
					dlg.Method.Invoke(dlg.Target, pList);
            }
        }
    }
}
