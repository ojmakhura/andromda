...
namespace AndroMDA.NHibernateSupport
{
    ...
    public class DefaultSessionManager : ISessionManager
    {
        ...
        public void HandleSessionStart()
        {
			...
			if (SessionFactory == null)
			{
				throw new Exception("SessionStart was called but the nhibernate session factory has not been initialized.");
			}
			if (!isSessionInitializedLazily)
			{
				OpenSession();
        ...
        public void HandleSessionEnd()
        {
            if (GetTransaction() != null)
                throw new Exception("SessionEnd was called but a transaction still exists.");
            CloseSession();
        }
        ...
        {
            if (GetTransaction() != null)
                throw new Exception("BeginTransaction was called but a transaction already exists.");
		...
		private void BuildSessionFactory()
		{
			...
			if (SettingExists("nhibernate.config"))
			{
				...
				{
					throw new Exception("An error occured while attempting to load nhibernate.config", e);
				}
			}
