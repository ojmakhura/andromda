...
public class Schema2UML2
{
    ...
    /**
     * The command line argument specifying the name of the tagged value to use
    ...
    /**
     * The command line argument specifying additional tagged values to add to
    ...
    public static void displayHelp()
    {
        ...
        formatter.printHelp(Schema2UML2.class.getName() + " [options] ...]]", "\nOptions:", options, "\n");
    }
    ...
    {
        Schema2UML2 schema2Xmi = new Schema2UML2();
        try
        {
            ...
            if (
                ...
                !(
                    commandLine.hasOption(INPUT_MODEL) && commandLine.hasOption(OUTPUT_MODEL)
                    //&& commandLine.hasOption(DRIVER) && commandLine.hasOption(CONNECTION_URL)
                    //&& commandLine.hasOption(PASSWORD) && commandLine.hasOption(USER)
                ))
            {
                Schema2UML2.displayHelp();
            }
            else
            {
