    ...
    A n d r o M D A  -  3.4.2-SNAPSHOT
    ...
    The project located in this directory has been generated by Bob Fields
    ...
    RSM7 and RSM75 and RSM8 are supported by AndroMDA 3.4.2-SNAPSHOT. To use an existing model with a generated project:
    ...
    M2_REPO/org/andromda/maven/plugins/andromda-maven-plugin/3.4.2-SNAPSHOT/andromda-maven-plugin-3.4.2-SNAPSHOT.pom
    to point to emf-uml2 instead of emf-uml22

    /jdbcmetadata J2EE project
         |
    ...
    this might be a directory looking like this:
        ...
        (*nix)
        /home/Bob Fields/.m2/repository/jdbcmetadata/
