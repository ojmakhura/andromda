        ...
        extends AdministrationController
{
     ...
     * @see org.andromda.samples.carrental.admins.web.main.AdministrationController#loadCarAndCarTypes(org.apache.struts.action.ActionMapping,
            *      org.andromda.samples.carrental.admins.web.main.LoadCarAndCarTypesForm, javax.servlet.http.HttpServletRequest,
            *      javax.servlet.http.HttpServletResponse)
     */
    public final void loadCarAndCarTypes(ActionMapping mapping,
                                         org.andromda.samples.carrental.admins.web.main.LoadCarAndCarTypesForm form,
    ...
    /**
     * This dummy variable is used to populate the "cars" table. You may delete it when you add you own code in this
     * controller.
     */
    private final java.util.Collection carsDummyList = java.util.Arrays.asList(new Object[]{
        new CarsDummy("inventoryNo-1", "registrationNo-1", "id-1"),
    ...
    /**
     * This dummy variable is used to populate the "carTypes" table. You may delete it when you add you own code in this
     * controller.
     */
    private final java.util.Collection carTypesDummyList = java.util.Arrays.asList(new Object[]{
        new CarTypesDummy("comfortClass-1", "identifier-1", "manufacter-1", "id-1"),
