    ...
    extends AdministrationController
{
     ...
     *      org.andromda.samples.carrental.admins.web.main.LoadCarAndCarTypesForm,
     *      javax.servlet.http.HttpServletRequest,
     *      javax.servlet.http.HttpServletResponse)
     */
    public final void loadCarAndCarTypes(
    ...
    /**
     * This dummy variable is used to populate the "cars" table. You may delete
     * it when you add you own code in this controller.
     */
    private final java.util.Collection carsDummyList =
        java.util.Arrays.asList(
            new Object[]
            {
                new CarsDummy("inventoryNo-1",
                    "registrationNo-1",
                    "id-1"), new CarsDummy(
                    "inventoryNo-2",
                    "registrationNo-2",
    ...
    /**
     * This dummy variable is used to populate the "carTypes" table. You may
     * delete it when you add you own code in this controller.
     */
    private final java.util.Collection carTypesDummyList =
        java.util.Arrays.asList(
            new Object[]
            {
                new CarTypesDummy(
                    ...
                    "identifier-1",
                    "manufacter-1",
                    "id-1"), new CarTypesDummy(
                    "comfortClass-2",
                    "identifier-2",
                    "manufacter-2",
                    "id-2"), new CarTypesDummy(
                    "comfortClass-3",
                    "identifier-3",
                    "manufacter-3",
                    "id-3"), new CarTypesDummy(
                    "comfortClass-4",
                    "identifier-4",
                    "manufacter-4",
                    "id-4"), new CarTypesDummy(
                    "comfortClass-5",
                    "identifier-5",
                    "manufacter-5",
                    "id-5")
