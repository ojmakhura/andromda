...
{
    /**
     * @see org.andromda.samples.carrental.contracts.web.handOut.HandOutCarController#loadAvailableCars(org.apache.struts.action.ActionMapping, org.andromda.samples.carrental.contracts.web.handOut.LoadAvailableCarsForm, javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse)
     */
    public final java.lang.String loadAvailableCars(ActionMapping mapping, org.andromda.samples.carrental.contracts.web.handOut.LoadAvailableCarsForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
    ...
    /**
     * @see org.andromda.samples.carrental.contracts.web.handOut.HandOutCarController#searchForReservationsOfCustomer(org.apache.struts.action.ActionMapping, org.andromda.samples.carrental.contracts.web.handOut.SearchForReservationsOfCustomerForm, javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse)
     */
    public final void searchForReservationsOfCustomer(ActionMapping mapping, org.andromda.samples.carrental.contracts.web.handOut.SearchForReservationsOfCustomerForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        // populating the table with a dummy list
    ...
    /**
     * @see org.andromda.samples.carrental.contracts.web.handOut.HandOutCarController#saveSelectedCar(org.apache.struts.action.ActionMapping, org.andromda.samples.carrental.contracts.web.handOut.SaveSelectedCarForm, javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse)
     */
    public final void saveSelectedCar(ActionMapping mapping, org.andromda.samples.carrental.contracts.web.handOut.SaveSelectedCarForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        // this property receives a default value, just to have the application running on dummy data
        form.setId("id-test");
    }
     ...
     */
    public static final class AvailableCarsDummy implements java.io.Serializable
    {
     ...
     * You may delete this class when you add you own code in this controller.
     */
    public static final class CustomerReservationsDummy implements java.io.Serializable
    {
