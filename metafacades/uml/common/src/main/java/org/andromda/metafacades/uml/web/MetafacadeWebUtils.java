...
public class MetafacadeWebUtils {
     ...
     * @throws IllegalArgumentException when the input string does not match the
     *                                  required pattern
     */
     ...
     * @param ownerParameter the optional owner parameter (if the element is an
    ...
    public static String parseValidatorName(final String validatorTaggedValue) {
        ...
        return (leftParen == -1) ? validatorTaggedValue
                : validatorTaggedValue.substring(
                        0,
                        leftParen);
    }
    ...
    public static boolean isStrictDateFormat(String format) {
        return strictDateTimeFormat ? strictDateTimeFormat
                : STRICT.equalsIgnoreCase(getToken(
                        format,
                        0,
                        2));
    }
     ...
     * 
     * @param format
     * @return <code>true</code> if this field is to be formatted as a credit card,
     ...
     * 
     * @param format
     * @return <code>true</code> if this field's value needs to respect a certain
     ...
     * 
     * @param format
     * @return <code>true</code> if this field's value needs to consist of at least
     *         a certain
     ...
     * 
     * @param format
     * @return <code>true</code> if this field's value needs to consist of at
     *         maximum a certain
     *         number of characters, <code>false</code> otherwise
     */
     ...
     * @param index
     * @param limit
     * @return the i-th space delimited token read from the argument String, where i
     ...
     * 
     * @param format
     * @return <code>true</code> if this field's value needs to be in a specific
    ...
    /**
     * @param type
     * @return <code>true</code> if the type of this field is a byte,
     *         <code>false</code> otherwise
     */
    ...
    /**
     * @param type
     * @return <code>true</code> if the type of this field is a short,
     *         <code>false</code> otherwise
     */
    ...
    /**
     * @param type
     * @return <code>true</code> if the type of this field is an integer,
     *         <code>false</code> otherwise
     */
    ...
    /**
     * @param type
     * @return <code>true</code> if the type of this field is a long integer,
     *         <code>false</code> otherwise
     */
    ...
    /**
     * @param type
     * @return <code>true</code> if the type of this field is a floating point,
     *         <code>false</code> otherwise
     */
    ...
    /**
     * @param type
     * @return <code>true</code> if the type of this field is a double precision
     *         floating point,
     *         <code>false</code> otherwise
     */
    ...
    /**
     * @param type
     * @return <code>true</code> if the type of this field is a date,
     *         <code>false</code> otherwise
     */
    ...
    /**
     * @param type
     * @return <code>true</code> if the type of this field is a time,
     *         <code>false</code> otherwise
     */
    ...
    /**
     * @param type
     * @return <code>true</code> if the type of this field is a URL,
     *         <code>false</code> otherwise
     */
     ...
     *
     * @param element        the element from which to retrieve the equal value.
     * @param ownerParameter the optional owner parameter (specified if the element
     *                       is an attribute).
     * @return the "equal" value.
     */
    ...
    public static Collection<String> getValidatorTypes(
        ...
        if (element != null && type != null) {
            ...
            if (isRangeFormat) {
                if (MetafacadeWebUtils.isInteger(type) || MetafacadeWebUtils.isShort(type)
                        || MetafacadeWebUtils.isLong(type)) {
    ...
    /**
     * Gets the validator args for the <code>element</code> and the given
    ...
    public static String getEnctype(ModelElementFacade modelElement) {
        ...
        String enctype = StringUtils
                .stripToNull(((String) modelElement.findTaggedValue(UMLProfile.TAGGEDVALUE_PRESENTATION_FORM_ENCTYPE)));
    ...
    public static String getInputMin(ModelElementFacade modelElement) {
        String min = StringUtils
                .stripToNull(((String) modelElement.findTaggedValue(MetafacadeWebProfile.TAGGEDVALUE_WEB_FIELD_MIN)));

        return min;
    }

    public static String getInputMax(ModelElementFacade modelElement) {
        String max = StringUtils
                .stripToNull(((String) modelElement.findTaggedValue(MetafacadeWebProfile.TAGGEDVALUE_WEB_FIELD_MAX)));
     ...
     */
    public static String getFormPropertyName(final ModelElementFacade parameter,
            final ModelElementFacade ownerParameter) {

        final StringBuilder propertyName = new StringBuilder();

        if (ownerParameter != null) {
            String beanName = Objects.toString(
                    ownerParameter.findTaggedValue(UMLProfile.TAGGEDVALUE_PRESENTATION_COMPONENT_BEAN_NAME), "").trim();

            if (StringUtils.isNotBlank(beanName)) {
                propertyName.append(beanName);
            } else {
     ...
     */
    public static String getFormPropertyId(final ModelElementFacade parameter,
            final ModelElementFacade ownerParameter) {
     ...
     */
    public static String getBackingListName(final ModelElementFacade parameter,
            final ModelElementFacade ownerParameter) {

        final String backingListName = StringUtilsHelper.replace(
                Objects.toString(
                        ((MetafacadeBase) parameter).getConfiguredProperty(MetafacadeWebGlobals.BACKING_LIST_PATTERN)),
                "{0}",
     ...
     */
    public static String handleGetBackingValueName(final ModelElementFacade parameter,
            final ModelElementFacade ownerParameter) {
        final String backingListName = StringUtilsHelper.replace(
                Objects.toString(
                        ((MetafacadeBase) parameter).getConfiguredProperty(MetafacadeWebGlobals.BACKING_VALUE_PATTERN)),
                "{0}",
                getFormPropertyId(parameter, ownerParameter));
        return org.andromda.utils.StringUtilsHelper.lowerCamelCaseName(backingListName);
    }
