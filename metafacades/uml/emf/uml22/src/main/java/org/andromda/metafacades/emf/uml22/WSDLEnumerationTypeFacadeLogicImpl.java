    ...
    extends WSDLEnumerationTypeFacadeLogic
{
     ...
     * The logger instance.
     */
    private static final Logger logger = Logger.getLogger(WSDLEnumerationTypeFacadeLogicImpl.class);
    ...
    /**
     * @return configuredProperty(WebServiceFacadeLogicImpl.NAMESPACE_PREFIX)
     ...
     * @return getConfiguredProperty(WebServiceFacadeLogicImpl.QNAME_LOCAL_PART_PATTERN)
     */
    ...
    /**
     * @return WebServiceMetafacadeUtils.reversePackage(packageName)
     ...
     * @param withPrefix
     * @param preserveArray
     * @return WebServiceMetafacadeUtils.getSchemaType
     * @see org.andromda.cartridges.webservice.metafacades.WSDLEnumerationType#getSchemaType(boolean, boolean)
     * @see org.andromda.cartridges.webservice.WebServiceMetafacadeUtils#getSchemaType(org.andromda.metafacades.uml.ClassifierFacade, TypeMappings, String, String, String, boolean, boolean)
     */
    ...
    /**
     * @return getConfiguredProperty(WebServiceMetafacadeGlobals.ARRAY_NAME_PREFIX)
    ...
    public Boolean useEnumValueInXSD()
    {
        ...
        // getConfiguredProperty is protected so we must wrap it for use in WebServiceMetafacadeUtils
        Object property = this.getConfiguredProperty(propertyName);
        if (property != null && String.class.isAssignableFrom(property.getClass()))
        {
