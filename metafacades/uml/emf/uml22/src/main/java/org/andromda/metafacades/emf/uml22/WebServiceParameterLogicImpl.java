    ...
    extends WebServiceParameterLogic
{
    ...
    {
        String paramType = (String)this.findTaggedValue(WebServiceMetafacadeGlobals.REST_PARAM_TYPE);
    ...
    {
        String pathParam = (String)this.findTaggedValue(WebServiceMetafacadeGlobals.REST_PATH_PARAM);
    ...
    {
        String pathSegment = (String)this.findTaggedValue(WebServiceMetafacadeGlobals.REST_PATH_SEGMENT);
