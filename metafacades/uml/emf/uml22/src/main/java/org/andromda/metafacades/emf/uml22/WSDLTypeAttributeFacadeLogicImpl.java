    ...
    extends WSDLTypeAttributeFacadeLogic
{
     ...
     * The logger instance.
     */
    private static final Logger logger = Logger.getLogger(WSDLTypeAttributeFacadeLogicImpl.class);
    ...
    {
        String adapter = (String)this.findTaggedValue(WebServiceMetafacadeGlobals.XML_ADAPTER);
    ...
    {
        String mode = (String)this.findTaggedValue(WebServiceMetafacadeGlobals.XML_TYPE);
    ...
    {
        boolean isAttribute = this.hasStereotype(WebServiceMetafacadeGlobals.STEREOTYPE_XML_ATTRIBUTE);
        boolean isElement = this.hasStereotype(WebServiceMetafacadeGlobals.STEREOTYPE_XML_ELEMENT);
        if (isElement)
        {
            if (isAttribute)
            {
    ...
    {
        boolean isAttribute = this.hasStereotype(WebServiceMetafacadeGlobals.STEREOTYPE_XML_ELEMENT);
        boolean isElement = this.hasStereotype(WebServiceMetafacadeGlobals.STEREOTYPE_XML_ELEMENT);
        if (isElement)
        {
            if (isAttribute)
