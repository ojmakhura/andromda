...
/**
 * Finds all translation tests from the current
 * base directory up.
 * 
 * @author Chad Brandon
 */
public class TranslationTestDiscoverer {
	...
	private static Logger logger = 
        Logger.getLogger(TranslationTestDiscoverer.class);
    ...
    /**
     * This is the prefix of translation tests, each translation
     * test must start with this in order to be found.
     */
     ...
     * The shared instance
     */
    private static final TranslationTestDiscoverer testFinder = 
        new TranslationTestDiscoverer();
     ...
     * current directory as specified by the system property
	...
	/**
	 * This method discovers all translation tests within the 
     * <code>currentDirectory</code>, it travels down the directory
     * structure looking for files that have a prefix of 'TranslationTest-'.
	 */
    ...
    /**
     * Returns the TranslationTest for the given 
     * <code>translation</code> (if one can be found),
    ...
    public TranslationTest getTest(String translation) {
        return (TranslationTest)
            this.translationTests.get(StringUtils.trimToEmpty(translation));
    }

	/**
	 * Returns the discovered translation tests keyed
     * by <code>translation<code>.
	 */
	public Map getTests() {
